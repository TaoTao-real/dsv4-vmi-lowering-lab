...
func.func @idx_qr_proj_dequant(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<i32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  %11 = pto.fusion_region {
    %16 = pto.alloc_tile addr = %c4096_i64 valid_row = %c8 valid_col = %c1024 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>
    pto.tcvt ins(%9 {candidates = [{id = 1 : i64, loop_depth = 2 : i64, name = "template_tcvt_i32_to_f32", postupdate = 0 : i64, tags = ["convert", "rowwise"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tcvt", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tcvt", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}, rmode = #pto<round_mode NONE>, satmode = #pto<saturation_mode OFF>} : !pto.tile_buf<vec, 8x1024xi32, valid=?x?>) outs(%16 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>)
    pto.yield(%16) : (!pto.tile_buf<vec, 8x1024xf32, valid=?x?>) -> ()
  ...
  %14 = pto.fusion_region {
    %16 = pto.alloc_tile addr = %c4096_i64 valid_row = %c8 valid_col = %c1024 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>
    pto.trowexpandmul ins(%11, %12 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>, !pto.tile_buf<vec, 8x1xf32, valid=?x?, blayout=col_major>) outs(%16 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_trowexpandmul", postupdate = 0 : i64, tags = ["row_expand", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_trowexpandmul", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_trowexpandmul", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    %17 = pto.alloc_tile addr = %c4096_i64 valid_row = %c8 valid_col = %c1024 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>
    pto.tcolexpandmul ins(%16, %8 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>, !pto.tile_buf<vec, 1x1024xf32, valid=?x?>) outs(%17 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tcolexpandmul", postupdate = 0 : i64, tags = ["column_expand", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tcolexpandmul", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tcolexpandmul", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%17) : (!pto.tile_buf<vec, 8x1024xf32, valid=?x?>) -> ()
  } {pto.fusion.group_id = 1 : i64} : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>
  %15 = pto.partition_view %3, offsets = [%c0, %c0, %c0, %c0, %5], sizes = [%c1, %c1, %c1, %c8, %c1024] : !pto.tensor_view<1x1x1x?x?xf32>
  pto.tstore ins(%14 : !pto.tile_buf<vec, 8x1024xf32, valid=?x?>) outs(%15 : !pto.partition_tensor_view<1x1x1x8x1024xf32>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
  return
}
