...
func.func @prefill_idx_topk(%arg0: !pto.ptr<i32, gm>, %arg1: !pto.ptr<i32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: index, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  scf.for %arg6 = %c0 to %c16 step %c1 {
    ...
    %7 = pto.fusion_region {
      %10 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c512 : !pto.tile_buf<vec, 1x512xi32, valid=?x?>
      pto.texpands ins(%c-1_i32 : i32) outs(%10 : !pto.tile_buf<vec, 1x512xi32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_texpands", postupdate = 0 : i64, tags = ["elementwise", "scalar", "fill"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands_i32", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands_i32", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
      pto.yield(%10) : (!pto.tile_buf<vec, 1x512xi32, valid=?x?>) -> ()
    } {pto.fusion.group_id = 0 : i64} : !pto.tile_buf<vec, 1x512xi32, valid=?x?>
