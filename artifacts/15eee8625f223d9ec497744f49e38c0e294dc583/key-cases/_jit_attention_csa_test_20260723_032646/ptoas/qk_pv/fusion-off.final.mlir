    ...
    func.func @qk_pv_aiv(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<i32, gm>, %arg4: !pto.ptr<f32, gm>, %arg5: !pto.ptr<i32, gm>, %arg6: !pto.ptr<i32, gm>, %arg7: !pto.ptr<bf16, gm>, %arg8: !pto.ptr<i32, gm>, %arg9: !pto.ptr<i32, gm>, %arg10: !pto.ptr<bf16, gm>, %arg11: !pto.ptr<bf16, gm>, %arg12: i32, %arg13: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      scf.for %arg14 = %c0 to %3 step %c1 {
        ...
        scf.if %21 {
          ...
          %25 = arith.muli %12, %c16 : index
          %26 = pto.addptr %23, %c0 : <f32, ub> -> <f32, ub>
          %27 = pto.addptr %24, %c0 : <f32, ub> -> <f32, ub>
          %28 = pto.castptr %c82496_i64 : i64 -> !pto.ptr<f32, ub>
          %29 = pto.addptr %28, %c0 : <f32, ub> -> <f32, ub>
          %30 = pto.castptr %c82624_i64 : i64 -> !pto.ptr<f32, ub>
          %31 = pto.addptr %30, %c0 : <f32, ub> -> <f32, ub>
          scf.for %arg15 = %c0 to %c2 step %c1 {
            %32 = pto.declare_tile_memref -> memref<32x128xf32, strided<[128, 1], offset: ?>, #pto.address_space<vec>>
            %33 = builtin.unrealized_conversion_cast %32 : memref<32x128xf32, strided<[128, 1], offset: ?>, #pto.address_space<vec>> to !pto.ptr<f32, ub>
            %34 = pto.materialize_tile %32, %c32, %c128 {__pto.force_dynamic_valid_shape, config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<32x128xf32, strided<[128, 1], offset: ?>, #pto.address_space<vec>> -> !pto.tile_buf<vec, 32x128xf32, valid=?x?>
            pto.wait_flag[<PIPE_V>, <PIPE_S>, <EVENT_ID0>]
            pto.tpop(%34, %0 : !pto.tile_buf<vec, 32x128xf32, valid=?x?>, !pto.pipe) {split = 0}
            ...
            pto.vecscope {
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                ...
                %54 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %c128) -> (index)  : i16 {
                  ...
                  %59 = pto.addptr %33, %58 : <f32, ub> -> <f32, ub>
                  ...
                  %61 = pto.addptr %22, %58 : <f32, ub> -> <f32, ub>
            ...
            pto.vecscope {
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                ...
                %54 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %c128) -> (index)  : i16 {
                  ...
                  %result = pto.vlds %59[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %60 = pto.addptr %4, %55 : <f32, ub> -> <f32, ub>
                  %result_3 = pto.vlds %60[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %61 = pto.vadd %result, %result_3, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  pto.vsts %61, %59[%c0], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                  scf.yield %57 : index
                }
            ...
            pto.vecscope {
              ...
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %53 = arith.index_cast %arg16 : i16 to index
                %54 = arith.muli %53, %c128 : index
                %55:2 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %52, %arg19 = %c128) -> (!pto.vreg<64xf32>, index)  : i16 {
                  %57 = arith.index_cast %arg17 : i16 to index
                  %58 = arith.index_cast %arg19 : index to i32
                  %mask_3, %scalar_out_4 = pto.plt_b32 %58 : i32 -> !pto.mask<b32>, i32
                  %59 = arith.index_cast %scalar_out_4 : i32 to index
                  %60 = arith.addi %54, %57 : index
                  %61 = pto.addptr %22, %60 : <f32, ub> -> <f32, ub>
                  %result = pto.vlds %61[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %62 = pto.vcmax %result, %mask_3 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %63 = pto.vsel %62, %arg18, %mask_3 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %64 = pto.vmax %arg18, %63, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  scf.yield %64, %59 : !pto.vreg<64xf32>, index
                }
                %56 = pto.addptr %23, %53 : <f32, ub> -> <f32, ub>
                pto.vsts %55#0, %56[%c0], %mask {dist = "1PT_B32"} : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              ...
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %53 = arith.index_cast %arg16 : i16 to index
                %54 = arith.muli %53, %c128 : index
                %55 = pto.addptr %23, %53 : <f32, ub> -> <f32, ub>
                %56 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %c128) -> (index)  : i16 {
                  %57 = arith.index_cast %arg17 : i16 to index
                  %58 = arith.index_cast %arg18 : index to i32
                  %mask_3, %scalar_out_4 = pto.plt_b32 %58 : i32 -> !pto.mask<b32>, i32
                  %59 = arith.index_cast %scalar_out_4 : i32 to index
                  %60 = arith.addi %54, %57 : index
                  %61 = pto.addptr %22, %60 : <f32, ub> -> <f32, ub>
                  %result = pto.vlds %61[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %result_5 = pto.vlds %55[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %62 = pto.vdup %result_5, %mask_3 {position = "LOWEST"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %63 = pto.vsub %result, %62, %mask_3 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  pto.vsts %63, %61[%c0], %mask_3 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                  scf.yield %59 : index
                }
              ...
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %53 = arith.index_cast %arg16 : i16 to index
                %54 = arith.muli %53, %c128 : index
                %55 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %c128) -> (index)  : i16 {
                  %56 = arith.index_cast %arg17 : i16 to index
                  %57 = arith.index_cast %arg18 : index to i32
                  %mask_3, %scalar_out_4 = pto.plt_b32 %57 : i32 -> !pto.mask<b32>, i32
                  %58 = arith.index_cast %scalar_out_4 : i32 to index
                  %59 = arith.addi %54, %56 : index
                  %60 = pto.addptr %22, %59 : <f32, ub> -> <f32, ub>
                  %result = pto.vlds %60[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %61 = pto.vexp %result, %mask_3 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  pto.vsts %61, %60[%c0], %mask_3 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                  scf.yield %58 : index
                }
            ...
            pto.vecscope {
              ...
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                ...
                %56:2 = scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg18 = %52, %arg19 = %c128) -> (!pto.vreg<64xf32>, index)  : i16 {
                  %58 = arith.index_cast %arg17 : i16 to index
                  %59 = arith.index_cast %arg19 : index to i32
                  %mask_5, %scalar_out_6 = pto.plt_b32 %59 : i32 -> !pto.mask<b32>, i32
                  %60 = arith.index_cast %scalar_out_6 : i32 to index
                  %61 = arith.addi %55, %58 : index
                  %62 = pto.addptr %22, %61 : <f32, ub> -> <f32, ub>
                  %result = pto.vlds %62[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %63 = pto.vcadd %result, %mask_5 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %64 = pto.vadd %arg18, %63, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  scf.yield %64, %60 : !pto.vreg<64xf32>, index
                }
                %57 = pto.addptr %24, %54 : <f32, ub> -> <f32, ub>
                pto.vsts %56#0, %57[%c0], %mask {dist = "1PT_B32"} : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              ...
              %53 = pto.castptr %c90880_i64 : i64 -> !pto.ptr<bf16, ub>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %54 = arith.index_cast %arg16 : i16 to index
                %55 = arith.muli %54, %c128 : index
                scf.for %arg17 = %c0_i16 to %c128_i16 step %c64_i16  : i16 {
                  ...
                  %58 = pto.addptr %22, %57 : <f32, ub> -> <f32, ub>
                  %result = pto.vlds %58[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %59 = pto.vcvt %result, %mask_3 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
                  %60 = pto.addptr %53, %57 : <bf16, ub> -> <bf16, ub>
                  pto.vsts %59, %60[%c0], %mask_3 {dist = "PK_B32"} : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b32>
                }
            ...
            %35 = pto.alloc_tile addr = %c82688_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>
            pto.vecscope {
              %52 = pto.castptr %c90880_i64 : i64 -> !pto.ptr<bf16, ub>
              %53 = pto.castptr %c82688_i64 : i64 -> !pto.ptr<bf16, ub>
              ...
              %54 = scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16 iter_args(%arg17 = %53) -> (!pto.ptr<bf16, ub>)  : i16 {
                %55 = arith.index_cast %arg16 : i16 to index
                %56 = arith.muli %55, %c128 : index
                %result = pto.vlds %52[%56] {dist = "NORM"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
                %57 = pto.vsstb %result, %arg17, %c32_i16, %c1_i16, %mask : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, i16, i16, !pto.mask<b16> -> !pto.ptr<bf16, ub>
                scf.yield %57 : !pto.ptr<bf16, ub>
            ...
            pto.tpush(%35, %0 : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>, !pto.pipe) {split = 0}
            %36 = arith.muli %arg15, %c2 : index
            %37 = arith.muli %arg15, %c160 : index
            %38 = arith.addi %13, %37 : index
            %39 = arith.addi %38, %25 : index
            %40 = pto.addptr %arg1, %39 : <f32, gm> -> <f32, gm>
            %41 = pto.addptr %40, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %26, %41, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            %42 = pto.addptr %arg0, %39 : <f32, gm> -> <f32, gm>
            ...
            %45 = arith.muli %44, %c80 : index
            %46 = arith.addi %13, %45 : index
            %47 = arith.addi %46, %25 : index
            pto.barrier <PIPE_MTE3>
            %48 = pto.addptr %arg1, %47 : <f32, gm> -> <f32, gm>
            %49 = pto.addptr %48, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %29, %49, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            pto.set_flag[<PIPE_MTE3>, <PIPE_V>, <EVENT_ID1>]
            %50 = pto.addptr %arg0, %47 : <f32, gm> -> <f32, gm>
            %51 = pto.addptr %50, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %31, %51, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            pto.set_flag[<PIPE_MTE3>, <PIPE_V>, <EVENT_ID2>]
          }
        } else {
          %22 = pto.castptr %c90880_i64 : i64 -> !pto.ptr<f32, ub>
