        ...
        scf.for %arg15 = %c0 to %c2 step %c1 {
          ...
          %28:3 = pto.fusion_region {
            ...
            scf.for %arg16 = %c0 to %c32 step %c1 {
              ...
              pto.vmi.vstore %114, %82[%112], %83 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
              %115 = arith.muli %arg16, %c128 : index
              %116 = pto.vmi.vload %85[%115] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
              %117 = pto.vmi.vexp %116, %88 : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
              pto.vmi.vstore %117, %87[%115], %88 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
