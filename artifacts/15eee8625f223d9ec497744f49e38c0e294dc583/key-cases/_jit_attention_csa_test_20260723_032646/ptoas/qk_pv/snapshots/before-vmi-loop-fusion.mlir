      ...
      scf.if %23 {
        scf.for %arg15 = %c0 to %c2 step %c1 {
          ...
          %28:3 = pto.fusion_region {
            ...
            scf.for %arg16 = %c0 to %c32 step %c1 {
              %110 = arith.muli %arg16, %c128 : index
              %111 = pto.vmi.vload %85[%110] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
              %112 = pto.vmi.vexp %111, %88 : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
              pto.vmi.vstore %112, %87[%110], %88 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
