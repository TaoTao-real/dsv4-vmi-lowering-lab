  ...
  func.func @rms_norm(%arg0: memref<?xbf16, #pto.address_space<gm>>, %arg1: memref<?xbf16, #pto.address_space<gm>>, %arg2: memref<?xbf16, #pto.address_space<gm>>, %arg3: i32, %arg4: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.for %arg5 = %c0 to %c32 step %c2 {
      ...
      %44 = pto.fusion_region {
        ...
        %82 = pto.vmi.vload %78[%c0] {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"} : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = arith.muli %arg6, %c128 : index
          %89 = pto.vmi.vload %76[%88] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %90 = pto.vmi.vmul %89, %82, %81 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %90, %80[%88], %81 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
