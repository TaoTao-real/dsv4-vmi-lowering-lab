  ...
  func.func @rms_norm(%arg0: memref<?xbf16, #pto.address_space<gm>>, %arg1: memref<?xbf16, #pto.address_space<gm>>, %arg2: memref<?xbf16, #pto.address_space<gm>>, %arg3: i32, %arg4: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.for %arg5 = %c0 to %c32 step %c2 {
      ...
      %37 = pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          ...
          %84 = pto.vmi.vload %50[%82] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %85 = pto.vmi.vmul %83, %84, %53 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %85, %52[%82], %53 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          ...
          %84 = pto.vmi.vload %73[%82] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %85 = pto.vmi.vmul %83, %84, %53 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %85, %75[%82], %53 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
    ...
    scf.for %arg5 = %c0 to %c32 step %c2 {
      ...
      %44 = pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = arith.muli %arg6, %c128 : index
          %89 = pto.vmi.vload %58[%88] : !pto.ptr<bf16, ub> -> !pto.vmi.vreg<128xbf16>
          %90 = pto.vmi.vcvt %89 : !pto.vmi.vreg<128xbf16> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %90, %60[%88], %61 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        } {pto.tilelib.candidate = "vmi_tcvt", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcvt"}
        ...
        %79 = pto.vmi.vload %78[%c0] {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"} : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
        %80 = pto.pointer_cast(%c8768_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xf32, #pto.address_space<vec>>
        %81 = pto.castptr %80 : memref<8x128xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %82 = pto.vmi.create_mask %c128 {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"} : index -> !pto.vmi.mask<128xpred>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = pto.vmi.vload %71[%arg6] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<1xf32>
          %89 = pto.vmi.vbrc %88 : !pto.vmi.vreg<1xf32> -> !pto.vmi.vreg<128xf32>
          %90 = arith.muli %arg6, %c128 : index
          %91 = pto.vmi.vload %69[%90] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %92 = pto.vmi.vmul %91, %89, %74 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %92, %73[%90], %74 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
          %93 = arith.muli %arg6, %c128 : index
          %94 = pto.vmi.vload %76[%93] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %95 = pto.vmi.vmul %94, %79, %82 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %95, %81[%93], %82 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
        pto.set_flag[<PIPE_V>, <PIPE_MTE2>, <EVENT_ID3>]
        %83 = pto.alloc_tile addr = %c8768_i64 valid_row = %c8 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 8x128xbf16, valid=?x?>
        %84 = pto.pointer_cast(%c8768_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xf32, #pto.address_space<vec>>
        %85 = pto.castptr %84 : memref<8x128xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %86 = pto.pointer_cast(%c8768_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xbf16, #pto.address_space<vec>>
        %87 = pto.castptr %86 : memref<8x128xbf16, #pto.address_space<vec>> -> !pto.ptr<bf16, ub>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = arith.muli %arg6, %c128 : index
          %89 = pto.vmi.vload %85[%88] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %90 = pto.vmi.vcvt %89 {rounding = "R", saturate = "NOSAT"} : !pto.vmi.vreg<128xf32> -> !pto.vmi.vreg<128xbf16>
          pto.vmi.vstore %90, %87[%88], %61 : !pto.vmi.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.vmi.mask<128xpred>
        } {pto.tilelib.candidate = "vmi_tcvt", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcvt"}
        pto.yield(%83) : (!pto.tile_buf<vec, 8x128xbf16, valid=?x?>) -> ()
      ...
      %51 = pto.fusion_region {
        ...
        %78 = pto.castptr %77 : memref<1x128xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %79 = pto.vmi.vload %78[%c0] {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"} : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
        %80 = pto.pointer_cast(%c12864_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xf32, #pto.address_space<vec>>
        %81 = pto.castptr %80 : memref<8x128xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %82 = pto.vmi.create_mask %c128 {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"} : index -> !pto.vmi.mask<128xpred>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = pto.vmi.vload %71[%arg6] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<1xf32>
        ...
        pto.set_flag[<PIPE_V>, <PIPE_MTE2>, <EVENT_ID4>]
        %83 = pto.alloc_tile addr = %c12864_i64 valid_row = %c8 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 8x128xbf16, valid=?x?>
        %84 = pto.pointer_cast(%c12864_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xf32, #pto.address_space<vec>>
        %85 = pto.castptr %84 : memref<8x128xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %86 = pto.pointer_cast(%c12864_i64) %c8, %c128 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<8x128xbf16, #pto.address_space<vec>>
        %87 = pto.castptr %86 : memref<8x128xbf16, #pto.address_space<vec>> -> !pto.ptr<bf16, ub>
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %88 = arith.muli %arg6, %c128 : index
          %89 = pto.vmi.vload %85[%88] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
