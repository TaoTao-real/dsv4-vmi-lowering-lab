  ...
  func.func @rmsnorm_rope(%arg0: memref<?xf32, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xbf16, #pto.address_space<gm>>, %arg4: memref<?xbf16, #pto.address_space<gm>>) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    %64:2 = pto.fusion_region {
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        ...
        %97 = pto.vmi.vload %84[%96] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %98 = pto.vmi.vmul %97, %90, %89 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %98, %88[%96], %89 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tcolexpandmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcolexpandmul"}
    ...
    %67:3 = pto.fusion_region {
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %90[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vmuls %151, %cst_1, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %152, %92[%150], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %105[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vcvt %151 {rounding = "A", saturate = "NOSAT"} : !pto.vmi.vreg<64xf32> -> !pto.vmi.vreg<64xi32>
        pto.vmi.vstore %152, %107[%150], %78 : !pto.vmi.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tcvt", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcvt"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %113[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vload %115[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %153 = pto.vmi.vsub %151, %152, %118 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %153, %117[%150], %118 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %120[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vadds %151, %cst_2, %123 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %152, %122[%150], %123 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %125[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vmuls %151, %cst_0, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %152, %127[%150], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmuls", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmuls"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %129[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vload %131[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %153 = pto.vmi.vsub %151, %152, %118 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %153, %133[%150], %118 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tsub", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tsub"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %150 = arith.muli %arg5, %c64 : index
        %151 = pto.vmi.vload %141[%150] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %152 = pto.vmi.vmuls %151, %cst_0, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %152, %143[%150], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmuls", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmuls"}
    ...
    %68 = pto.fusion_region {
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %101 = arith.muli %arg5, %c64 : index
        %102 = pto.vmi.vload %82[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %103 = pto.vmi.vload %84[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %104 = pto.vmi.vmul %102, %103, %80 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %104, %86[%101], %80 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %101 = arith.muli %arg5, %c64 : index
        %102 = pto.vmi.vload %88[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %103 = pto.vmi.vload %90[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %104 = pto.vmi.vmul %102, %103, %80 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %104, %92[%101], %80 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
