...
func.func @rmsnorm_rope(%arg0: memref<?xf32, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xbf16, #pto.address_space<gm>>, %arg4: memref<?xbf16, #pto.address_space<gm>>) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  scf.for %arg5 = %c0 to %c128 step %c64 {
    ...
    pto.fusion_region {
      ...
      scf.for %arg6 = %c0 to %c16 step %c1 {
        ...
        %100 = pto.vmi.vmul %99, %99, %90 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %100, %89[%98], %90 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
  ...
  %64:2 = pto.fusion_region {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      %101 = pto.vmi.vmul %100, %87, %90 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
  ...
  %67:3 = pto.fusion_region {
    ...
    %92 = pto.vmi.create_mask %c64 {pto.tilelib.candidate = "vmi_tmuls", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmuls"} : index -> !pto.vmi.mask<64xpred>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %82[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %151 = pto.vmi.vmul %150, %80, %87 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %151, %86[%149], %87 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %152 = pto.vmi.vmuls %151, %cst_1, %92 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %152, %91[%149], %92 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    %93 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %94 = pto.castptr %93 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %95 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, #pto.address_space<vec>>
    %96 = pto.castptr %95 : memref<16x64xi32, #pto.address_space<vec>> -> !pto.ptr<i32, ub>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %94[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %151 = pto.vmi.vcvt %150 {rounding = "Z", saturate = "NOSAT"} : !pto.vmi.vreg<64xf32> -> !pto.vmi.vreg<64xi32>
      pto.vmi.vstore %151, %96[%149], %78 : !pto.vmi.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.vmi.mask<64xpred>
    ...
    %97 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, #pto.address_space<vec>>
    %98 = pto.castptr %97 : memref<16x64xi32, #pto.address_space<vec>> -> !pto.ptr<i32, ub>
    ...
    %101 = pto.pointer_cast(%c16448_i64) %c16, %c64 {__pto.force_dynamic_valid_shape, config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>
    %102 = pto.bind_tile %101, %c16, %c64 {__pto.force_dynamic_valid_shape, config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>> -> memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>
    %103 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %104 = pto.castptr %103 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %105 = pto.pointer_cast(%c16448_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, #pto.address_space<vec>>
    %106 = pto.castptr %105 : memref<16x64xi32, #pto.address_space<vec>> -> !pto.ptr<i32, ub>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %98[%149] : !pto.ptr<i32, ub> -> !pto.vmi.vreg<64xi32>
      %151 = pto.vmi.vcvt %150 {rounding = "A"} : !pto.vmi.vreg<64xi32> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %151, %100[%149], %78 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %152 = pto.vmi.vcvt %151 {rounding = "A", saturate = "NOSAT"} : !pto.vmi.vreg<64xf32> -> !pto.vmi.vreg<64xi32>
      pto.vmi.vstore %152, %106[%149], %78 : !pto.vmi.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    %107 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %108 = pto.castptr %107 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %109 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %110 = pto.castptr %109 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %111 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %112 = pto.castptr %111 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %113 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %114 = pto.castptr %113 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %115 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %116 = pto.castptr %115 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %117 = pto.vmi.create_mask %c64 {pto.tilelib.candidate = "vmi_tsub", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tsub"} : index -> !pto.vmi.mask<64xpred>
    %118 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    ...
    %122 = pto.vmi.create_mask %c64 {pto.tilelib.candidate = "vmi_tadds", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tadds"} : index -> !pto.vmi.mask<64xpred>
    %123 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %124 = pto.castptr %123 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %125 = pto.pointer_cast(%c20544_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %126 = pto.castptr %125 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %127 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %128 = pto.castptr %127 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %129 = pto.pointer_cast(%c20544_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %130 = pto.castptr %129 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %131 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %132 = pto.castptr %131 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %108[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %151 = pto.vmi.vmuls %150, %cst_0, %92 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      %152 = pto.vmi.vload %112[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %153 = pto.vmi.vsub %152, %151, %117 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %153, %116[%149], %117 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %154 = pto.vmi.vadds %152, %cst_2, %122 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      %155 = pto.vmi.vmuls %153, %cst_0, %92 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %155, %126[%149], %92 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %156 = pto.vmi.vsub %154, %155, %117 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %156, %132[%149], %117 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    %133 = pto.pointer_cast(%c0_i64) %c16, %c64 {__pto.force_dynamic_valid_shape, config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>
    %134 = pto.bind_tile %133, %c16, %c64 {__pto.force_dynamic_valid_shape, config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>> -> memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>
    %135 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %136 = pto.castptr %135 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %137 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xi32, #pto.address_space<vec>>
    %138 = pto.castptr %137 : memref<16x64xi32, #pto.address_space<vec>> -> !pto.ptr<i32, ub>
    %139 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %140 = pto.castptr %139 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %141 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %142 = pto.castptr %141 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %136[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %151 = pto.vmi.vcvt %150 {rounding = "A", saturate = "NOSAT"} : !pto.vmi.vreg<64xf32> -> !pto.vmi.vreg<64xi32>
      pto.vmi.vstore %151, %138[%149], %78 : !pto.vmi.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.vmi.mask<64xpred>
      %152 = pto.vmi.vload %140[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %153 = pto.vmi.vmuls %152, %cst_0, %92 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %153, %142[%149], %92 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    %143 = pto.alloc_tile addr = %c12352_i64 valid_row = %c16 valid_col = %c64 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 16x64xf32, valid=?x?>
    %144 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %145 = pto.castptr %144 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %146 = pto.pointer_cast(%c12352_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
    %147 = pto.castptr %146 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
    %148 = pto.vmi.create_mask %c64 {pto.tilelib.candidate = "vmi_tsubs", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tsubs"} : index -> !pto.vmi.mask<64xpred>
    scf.for %arg5 = %c0 to %c16 step %c1 {
      %149 = arith.muli %arg5, %c64 : index
      %150 = pto.vmi.vload %145[%149] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %151 = pto.vmi.vadds %150, %cst, %148 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %151, %147[%149], %148 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    ...
    pto.yield(%102, %134, %143) : (memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>, memref<16x64xi32, strided<[64, 1], offset: ?>, #pto.address_space<vec>>, !pto.tile_buf<vec, 16x64xf32, valid=?x?>) -> ()
  ...
  %68 = pto.fusion_region {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      %105 = pto.vmi.vload %82[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %106 = pto.vmi.vload %84[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %107 = pto.vmi.vmul %105, %106, %80 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      %108 = pto.vmi.vload %90[%101] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %109 = pto.vmi.vmul %107, %108, %80 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %109, %92[%101], %80 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
