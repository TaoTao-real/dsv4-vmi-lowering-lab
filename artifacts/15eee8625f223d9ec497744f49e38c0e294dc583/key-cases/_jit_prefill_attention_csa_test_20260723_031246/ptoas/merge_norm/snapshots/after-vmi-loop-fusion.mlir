      ...
      scf.if %5 {
        ...
        scf.for %arg10 = %c1 to %c3 step %c1 {
          ...
          pto.fusion_region {
            ...
            scf.for %arg11 = %c0 to %c16 step %c1 {
              ...
              %122 = arith.muli %arg11, %c512 : index
              %123 = pto.vmi.vload %111[%122] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<512xf32>
              %124 = pto.vmi.vload %113[%122] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<512xf32>
              %125 = pto.vmi.vadd %123, %124, %116 : !pto.vmi.vreg<512xf32>, !pto.vmi.vreg<512xf32>, !pto.vmi.mask<512xpred> -> !pto.vmi.vreg<512xf32>
              pto.vmi.vstore %125, %115[%122], %116 : !pto.vmi.vreg<512xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<512xpred>
        ...
        pto.fusion_region {
          ...
          scf.for %arg10 = %c0 to %c16 step %c1 {
            ...
            %27 = arith.muli %arg10, %c512 : index
            pto.vmi.vstore %20, %18[%27], %19 : !pto.vmi.vreg<512xbf16>, !pto.ptr<bf16, ub>, !pto.vmi.mask<512xpred>
            %28 = arith.muli %arg10, %c512 : index
            %29 = pto.vmi.vload %22[%28] : !pto.ptr<bf16, ub> -> !pto.vmi.vreg<512xbf16>
            pto.vmi.vstore %29, %24[%28], %25 : !pto.vmi.vreg<512xbf16>, !pto.ptr<bf16, ub>, !pto.vmi.mask<512xpred>
          } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
          pto.yield() : () -> ()
