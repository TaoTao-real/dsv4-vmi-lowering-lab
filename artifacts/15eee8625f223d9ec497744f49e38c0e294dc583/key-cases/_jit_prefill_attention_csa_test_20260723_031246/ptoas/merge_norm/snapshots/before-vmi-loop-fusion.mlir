      ...
      scf.if %5 {
        ...
        scf.for %arg10 = %c1 to %c3 step %c1 {
          ...
          pto.fusion_region {
            ...
            scf.for %arg11 = %c0 to %c16 step %c1 {
              %117 = arith.muli %arg11, %c512 : index
              %118 = pto.vmi.vload %111[%117] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<512xf32>
              %119 = pto.vmi.vload %113[%117] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<512xf32>
              %120 = pto.vmi.vadd %118, %119, %116 : !pto.vmi.vreg<512xf32>, !pto.vmi.vreg<512xf32>, !pto.vmi.mask<512xpred> -> !pto.vmi.vreg<512xf32>
              pto.vmi.vstore %120, %115[%117], %116 : !pto.vmi.vreg<512xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<512xpred>
        ...
        pto.fusion_region {
          ...
          scf.for %arg10 = %c0 to %c16 step %c1 {
            %26 = arith.muli %arg10, %c512 : index
            %27 = pto.vmi.vload %22[%26] : !pto.ptr<bf16, ub> -> !pto.vmi.vreg<512xbf16>
            pto.vmi.vstore %27, %24[%26], %25 : !pto.vmi.vreg<512xbf16>, !pto.ptr<bf16, ub>, !pto.vmi.mask<512xpred>
