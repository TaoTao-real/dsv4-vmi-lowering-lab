  ...
  scf.if %31 {
    ...
    scf.for %arg12 = %c0 to %c4 step %c1 {
      ...
      pto.fusion_region {
        ...
        pto.texpands ins(%cst_0 : f32) outs(%61 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_texpands", postupdate = 0 : i64, tags = ["elementwise", "scalar", "fill"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
      ...
      scf.if %50 {
        %59 = arith.divsi %48, %c4 : index
        %60 = arith.muli %59, %c4 : index
        %61 = arith.subi %48, %60 : index
        ...
        scf.if %64 {
          ...
          %68 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
          %69 = pto.partition_view %3, offsets = [%c0, %c0, %c0, %67, %26], sizes = [%c1, %c1, %c1, %c1, %c256] : !pto.tensor_view<1x1x1x?x?xf32>
          pto.tload ins(%69 : !pto.partition_tensor_view<1x1x1x1x256xf32>) outs(%68 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
          %70 = pto.subview %27[%arg12, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
          pto.fusion_region {
            pto.tmov ins(%68 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%70 : !pto.tile_buf<vec, 1x256xf32>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmov_basic", postupdate = 0 : i64, tags = ["move", "ub", "ub"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}}
            pto.yield() : () -> ()
          } {pto.fusion.group_id = 4 : i64} :
          %71 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
          %72 = arith.addi %26, %c1024 : index
          %73 = pto.partition_view %3, offsets = [%c0, %c0, %c0, %67, %72], sizes = [%c1, %c1, %c1, %c1, %c256] : !pto.tensor_view<1x1x1x?x?xf32>
          pto.tload ins(%73 : !pto.partition_tensor_view<1x1x1x1x256xf32>) outs(%71 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
          %74 = pto.subview %28[%arg12, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
          pto.fusion_region {
      ...
      %51 = arith.addi %34, %arg12 : index
      %52 = arith.addi %arg12, %c4 : index
      pto.fusion_region {
        %59 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
        pto.texpands ins(%cst : f32) outs(%59 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_texpands", postupdate = 0 : i64, tags = ["elementwise", "scalar", "fill"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
        %60 = pto.subview %9[%52, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
        pto.tmov ins(%59 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%60 : !pto.tile_buf<vec, 1x256xf32>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmov_basic", postupdate = 0 : i64, tags = ["move", "ub", "ub"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}}
        %61 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
        pto.texpands ins(%cst_0 : f32) outs(%61 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_texpands", postupdate = 0 : i64, tags = ["elementwise", "scalar", "fill"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
        %62 = pto.subview %10[%52, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
        pto.tmov ins(%61 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%62 : !pto.tile_buf<vec, 1x256xf32>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmov_basic", postupdate = 0 : i64, tags = ["move", "ub", "ub"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}}
        pto.yield() : () -> ()
      } {pto.fusion.group_id = 3 : i64} :
      %53 = arith.divsi %51, %c4 : index
      %54 = arith.muli %53, %c4 : index
      %55 = arith.subi %51, %54 : index
      %56 = pto.load_scalar %arg2[%53] : !pto.ptr<i32, gm> -> i32
      %57 = arith.index_cast %56 : i32 to index
      %58 = arith.cmpi sge, %57, %c0 : index
      scf.if %58 {
        %59 = arith.index_cast %56 : i32 to index
        %60 = arith.muli %59, %c4 : index
        %61 = arith.addi %60, %55 : index
        %62 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
        %63 = arith.addi %26, %c512 : index
        %64 = pto.partition_view %3, offsets = [%c0, %c0, %c0, %61, %63], sizes = [%c1, %c1, %c1, %c1, %c256] : !pto.tensor_view<1x1x1x?x?xf32>
        pto.tload ins(%64 : !pto.partition_tensor_view<1x1x1x1x256xf32>) outs(%62 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
        %65 = pto.subview %9[%52, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
        pto.fusion_region {
          pto.tmov ins(%62 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%65 : !pto.tile_buf<vec, 1x256xf32>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmov_basic", postupdate = 0 : i64, tags = ["move", "ub", "ub"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}}
          pto.yield() : () -> ()
        } {pto.fusion.group_id = 6 : i64} :
        %66 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
        %67 = arith.addi %26, %c1536 : index
        %68 = pto.partition_view %3, offsets = [%c0, %c0, %c0, %61, %67], sizes = [%c1, %c1, %c1, %c1, %c256] : !pto.tensor_view<1x1x1x?x?xf32>
        ...
        %69 = pto.subview %10[%52, %c0] sizes [1, 256] valid [%c1, %c256] : !pto.tile_buf<vec, 8x256xf32, valid=?x?> -> !pto.tile_buf<vec, 1x256xf32>
        pto.fusion_region {
    ...
    scf.for %arg12 = %c0 to %c7 step %c1 {
      ...
      scf.if %51 {
        ...
        pto.fusion_region {
          ...
          pto.tsub ins(%59, %62 : !pto.tile_buf<vec, 1x256xf32>, !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%65 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tsub", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tsub", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 2 : i64, name = "template_tsub", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, pto.vmi.fusion.boundary = "local", pto.vmi.fusion.boundary_reason = "non_vmi_local_boundary_fallback"}
          ...
          pto.tmul ins(%61, %66 : !pto.tile_buf<vec, 1x256xf32>, !pto.tile_buf<vec, 1x256xf32, valid=?x?>) outs(%70 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmul", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmul", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 2 : i64, name = "template_tmul", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, pto.vmi.fusion.boundary = "local", pto.vmi.fusion.boundary_reason = "non_vmi_local_boundary_fallback"}
    ...
    %32 = pto.fusion_region {
      %34 = pto.alloc_tile addr = %c14336_i64 valid_row = %c1 valid_col = %c256 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>
      pto.texpands ins(%cst : f32) outs(%34 : !pto.tile_buf<vec, 1x256xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_texpands", postupdate = 0 : i64, tags = ["elementwise", "scalar", "fill"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_texpands", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
      pto.yield(%34) : (!pto.tile_buf<vec, 1x256xf32, valid=?x?>) -> ()
