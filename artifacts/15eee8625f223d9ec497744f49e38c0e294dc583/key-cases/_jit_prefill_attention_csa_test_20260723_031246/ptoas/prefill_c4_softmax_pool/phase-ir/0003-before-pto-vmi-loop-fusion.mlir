  ...
  func.func @prefill_c4_softmax_pool(%arg0: memref<?xi32, #pto.address_space<gm>>, %arg1: memref<?xi32, #pto.address_space<gm>>, %arg2: memref<?xi32, #pto.address_space<gm>>, %arg3: memref<?xf32, #pto.address_space<gm>>, %arg4: memref<?xi32, #pto.address_space<gm>>, %arg5: memref<?xf32, #pto.address_space<gm>>, %arg6: memref<?xf32, #pto.address_space<gm>>, %arg7: memref<?xf32, #pto.address_space<gm>>, %arg8: memref<?xf32, #pto.address_space<gm>>, %arg9: index, %arg10: i32, %arg11: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.if %7 {
      ...
      pto.fusion_region {
        ...
        scf.for %arg12 = %c0 to %c256 step %c64 {
          %46 = pto.vmi.vload %27[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %47 = pto.vmi.vload %29[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %48 = pto.vmi.vsub %46, %47, %32 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %48, %31[%arg12], %32 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        ...
        scf.for %arg12 = %c0 to %c256 step %c64 {
          %46 = pto.vmi.vload %34[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %47 = pto.vmi.vexp %46, %37 : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %47, %36[%arg12], %37 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        ...
        %41 = pto.castptr %40 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        scf.for %arg12 = %c0 to %c256 step %c64 {
          %46 = pto.vmi.vload %39[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %46, %41[%arg12], %25 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
        ...
        scf.for %arg12 = %c0 to %c256 step %c64 {
          %46 = pto.vmi.vload %43[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %46, %45[%arg12], %25 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
        pto.yield() : () -> ()
        ...
        scf.if %23 {
          ...
          pto.fusion_region {
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              ...
              pto.vmi.vstore %87, %33[%arg13], %34 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tsub", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tsub"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %36[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %86 = pto.vmi.vexp %85, %39 : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %86, %38[%arg13], %39 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_texp_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "texp"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %46[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %86 = pto.vmi.vload %48[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %87 = pto.vmi.vmul %85, %86, %51 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %87, %50[%arg13], %51 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %53[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %86 = pto.vmi.vload %55[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %87 = pto.vmi.vadd %85, %86, %58 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %87, %57[%arg13], %58 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tadd_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tadd"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %60[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %86 = pto.vmi.vload %62[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %87 = pto.vmi.vmul %85, %86, %51 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %87, %64[%arg13], %51 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %73[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %85, %75[%arg13], %76 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %78[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %85, %80[%arg13], %76 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              %85 = pto.vmi.vload %82[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %85, %84[%arg13], %76 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
            pto.yield() : () -> ()
