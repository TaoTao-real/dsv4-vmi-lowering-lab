    ...
    scf.if %7 {
      ...
      pto.fusion_region {
        ...
        scf.for %arg12 = %c0 to %c256 step %c64 {
          ...
          %47 = pto.vmi.vload %27[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %48 = pto.vmi.vload %29[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %49 = pto.vmi.vsub %47, %48, %32 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %49, %31[%arg12], %32 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
          %50 = pto.vmi.vload %34[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %51 = pto.vmi.vexp %50, %37 : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %51, %36[%arg12], %37 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
          %52 = pto.vmi.vload %39[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %52, %41[%arg12], %25 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
          %53 = pto.vmi.vload %43[%arg12] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %53, %45[%arg12], %25 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        ...
        scf.if %23 {
          ...
          pto.fusion_region {
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              ...
              %88 = pto.vmi.vload %36[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %89 = pto.vmi.vexp %88, %39 : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %89, %38[%arg13], %39 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              ...
              pto.vmi.vstore %89, %50[%arg13], %51 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
              %90 = pto.vmi.vload %53[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %91 = pto.vmi.vload %55[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %92 = pto.vmi.vadd %90, %91, %58 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %92, %57[%arg13], %58 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
              %93 = pto.vmi.vload %60[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %94 = pto.vmi.vload %62[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              %95 = pto.vmi.vmul %93, %94, %51 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %95, %64[%arg13], %51 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            ...
            scf.for %arg13 = %c0 to %c256 step %c64 {
              ...
              %90 = pto.vmi.vload %82[%arg13] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
              pto.vmi.vstore %90, %84[%arg13], %76 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
            } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            pto.yield() : () -> ()
