...
func.func @kv_and_cache_write(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<i8, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<i32, gm>, %arg4: !pto.ptr<i64, gm>, %arg5: !pto.ptr<f32, gm>) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  %8 = pto.fusion_region {
    %24 = pto.alloc_tile addr = %c16448_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xbf16, valid=?x?>
  ...
  %9 = pto.alloc_tile addr = %c8256_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xf32, valid=?x?>
  ...
  %10 = pto.alloc_tile addr = %c16448_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xf32, valid=?x?>
  ...
  pto.fusion_region {
    %24 = pto.alloc_tile addr = %c8192_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
  ...
  %12 = pto.alloc_tile addr = %c8192_i64 valid_row = %c1 valid_col = %c16 : !pto.tile_buf<vec, 1x16xf32, valid=?x?>
  %13 = pto.alloc_tile addr = %c16448_i64 valid_row = %c1 valid_col = %c16 : !pto.tile_buf<vec, 1x16xf32, valid=?x?>
  ...
  %14 = pto.fusion_region {
    %24 = pto.alloc_tile addr = %c16448_i64 valid_row = %c1 valid_col = %c16 : !pto.tile_buf<vec, 1x16xf32, valid=?x?>
  ...
  %15 = pto.alloc_tile addr = %c0_i64 valid_row = %c1 valid_col = %c16 : !pto.tile_buf<vec, 1x16xf32, valid=?x?>
  ...
  %17 = pto.alloc_tile addr = %c0_i64 valid_row = %c1 valid_col = %c16 : !pto.tile_buf<vec, 1x16xf32, valid=?x?>
  ...
  %18 = pto.alloc_tile addr = %c0_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
  %19 = pto.alloc_tile addr = %c16448_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
  %20 = pto.alloc_tile addr = %c8256_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xf32, valid=?x?>
  ...
  %21 = pto.alloc_tile addr = %c8256_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xi32, valid=?x?>
  ...
  %22 = pto.alloc_tile addr = %c8256_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xf16, valid=?x?>
  ...
  %23 = pto.alloc_tile addr = %c8256_i64 valid_row = %c16 valid_col = %c128 : !pto.tile_buf<vec, 16x128xi8, valid=?x?>
  ...
  scf.for %arg6 = %c0 to %c4 step %c1 {
    ...
    %25 = pto.load_scalar %arg3[%24] : !pto.ptr<i32, gm> -> i32
    %26 = arith.index_cast %25 : i32 to index
    %27 = arith.remsi %26, %c4 : index
    %28 = arith.cmpi sge, %27, %c2 : index
    scf.if %28 {
      %29 = arith.subi %c3, %27 : index
      %30 = pto.alloc_tile addr = %c16448_i64 valid_row = %c1 valid_col = %c128 : !pto.tile_buf<vec, 1x128xf32, valid=?x?>
      %31 = pto.partition_view %0, offsets = [%c0, %c0, %c0, %arg6, %c0], sizes = [%c1, %c1, %c1, %c1, %c128] : !pto.tensor_view<1x1x1x?x?xf32>
      pto.tload ins(%31 : !pto.partition_tensor_view<1x1x1x1x128xf32>) outs(%30 : !pto.tile_buf<vec, 1x128xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tload_nd2nd", postupdate = 0 : i64, tags = ["load", "gm", "ub", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
      %32 = arith.muli %arg6, %c2 : index
      %33 = arith.addi %32, %29 : index
      %34 = pto.load_scalar %arg4[%33] : !pto.ptr<i64, gm> -> i64
      %35 = arith.index_cast %34 : i64 to index
      %36 = arith.cmpi sge, %35, %c0 : index
      scf.if %36 {
        %37 = arith.index_cast %34 : i64 to index
        %38 = arith.muli %arg6, %c2 : index
        %39 = pto.partition_view %2, offsets = [%c0, %c0, %c0, %38, %c0], sizes = [%c1, %c1, %c1, %c1, %c128] : !pto.tensor_view<1x1x1x?x?xf32>
        pto.tstore ins(%30 : !pto.tile_buf<vec, 1x128xf32, valid=?x?>) outs(%39 : !pto.partition_tensor_view<1x1x1x1x128xf32>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
        %40 = pto.alloc_tile addr = %c8256_i64 valid_row = %c1 valid_col = %c128 : !pto.tile_buf<vec, 1x128xi8, valid=?x?>
        %41 = pto.subview %23[%arg6, %c0] sizes [1, 128] : !pto.tile_buf<vec, 16x128xi8, valid=?x?> -> !pto.tile_buf<vec, 1x128xi8>
        %42 = pto.partition_view %1, offsets = [%c0, %c0, %c0, %37, %c0], sizes = [%c1, %c1, %c1, %c1, %c128] : !pto.tensor_view<1x1x1x?x?xi8>
        pto.tstore ins(%41 : !pto.tile_buf<vec, 1x128xi8>) outs(%42 : !pto.partition_tensor_view<1x1x1x1x128xi8>) {candidates = [{id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}], layout = #pto.layout<nd>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 0 : i64, loop_depth = 3 : i64, name = "template_tstore_nd", postupdate = 0 : i64, tags = ["store", "ub", "gm", "nd"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
        %43 = pto.tgetval ins(%18, %arg6 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>, index) outs : f32
        pto.store_scalar %43, %arg5[%37] : !pto.ptr<f32, gm>, f32
      } else {
      }
    } else {
    }
