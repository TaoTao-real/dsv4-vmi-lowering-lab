    ...
    scf.for %arg8 = %c0 to %c3 step %c1 {
      ...
      scf.for %arg9 = %c0 to %c2 step %c1 {
        ...
        %25 = pto.fusion_region {
          ...
          pto.tmov ins(%24 : !pto.tile_buf<vec, 32x128xbf16, valid=?x?>) outs(%49 : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>) {candidates = [{id = 8 : i64, loop_depth = 1 : i64, name = "template_tmov_nd2nz", postupdate = 1 : i64, tags = ["move", "ub", "ub", "nd2nz", "nz"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmov", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop", "supports_partial_valid_shape"], tail = 0 : i64}}
          pto.yield(%49) : (!pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>) -> ()
        } {pto.fusion.group_id = 7 : i64} : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>
        pto.tpush(%25, %8 : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>, !pto.pipe) {split = 0}
        %26 = arith.muli %arg9, %c2 : index
        %27 = arith.muli %26, %c48 : index
        %28 = arith.addi %11, %27 : index
        %29 = arith.muli %arg8, %c16 : index
        %30 = arith.addi %28, %29 : index
        %31 = pto.alloc_tile addr = %c65536_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
        %32 = pto.subview %19[%c0, %c0] sizes [16, 1] : !pto.tile_buf<vec, 32x1xf32, valid=?x?, blayout=col_major> -> !pto.tile_buf<vec, 16x1xf32, blayout=col_major>
        %33 = pto.partition_view %1, offsets = [%c0, %c0, %c0, %30, %c0], sizes = [%c1, %c1, %c1, %c16, %c1] : !pto.tensor_view<1x1x1x?x?xf32>
        pto.tstore ins(%32 : !pto.tile_buf<vec, 16x1xf32, blayout=col_major>) outs(%33 : !pto.partition_tensor_view<1x1x1x16x1xf32>) {candidates = [{id = 1 : i64, loop_depth = 3 : i64, name = "template_tstore_dn", postupdate = 0 : i64, tags = ["store", "ub", "gm", "dn"], tail = 0 : i64}], layout = #pto.layout<dn>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 1 : i64, loop_depth = 3 : i64, name = "template_tstore_dn", postupdate = 0 : i64, tags = ["store", "ub", "gm", "dn"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
        %34 = pto.alloc_tile addr = %c65664_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
        %35 = pto.subview %23[%c0, %c0] sizes [16, 1] : !pto.tile_buf<vec, 32x1xf32, valid=?x?, blayout=col_major> -> !pto.tile_buf<vec, 16x1xf32, blayout=col_major>
        %36 = pto.partition_view %0, offsets = [%c0, %c0, %c0, %30, %c0], sizes = [%c1, %c1, %c1, %c16, %c1] : !pto.tensor_view<1x1x1x?x?xf32>
        pto.tstore ins(%35 : !pto.tile_buf<vec, 16x1xf32, blayout=col_major>) outs(%36 : !pto.partition_tensor_view<1x1x1x16x1xf32>) {candidates = [{id = 1 : i64, loop_depth = 3 : i64, name = "template_tstore_dn", postupdate = 0 : i64, tags = ["store", "ub", "gm", "dn"], tail = 0 : i64}], layout = #pto.layout<dn>, pto.tilelib.impl = "ptodsl", pto.tilelib.selected_candidate = {id = 1 : i64, loop_depth = 3 : i64, name = "template_tstore_dn", postupdate = 0 : i64, tags = ["store", "ub", "gm", "dn"], tail = 0 : i64}, pto.vmi.fusion.boundary = "hard", pto.vmi.fusion.boundary_reason = "non_vmi_hard_boundary_fallback"}
        %37 = arith.muli %arg9, %c2 : index
        %38 = arith.addi %37, %c1 : index
        %39 = arith.muli %38, %c48 : index
        %40 = arith.addi %11, %39 : index
        %41 = arith.muli %arg8, %c16 : index
        %42 = arith.addi %40, %41 : index
        %43 = pto.alloc_tile addr = %c65536_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
        %44 = pto.subview %19[%c16, %c0] sizes [16, 1] : !pto.tile_buf<vec, 32x1xf32, valid=?x?, blayout=col_major> -> !pto.tile_buf<vec, 16x1xf32, blayout=col_major>
        ...
        %46 = pto.alloc_tile addr = %c65664_i64 valid_row = %c16 valid_col = %c1 : !pto.tile_buf<vec, 16x1xf32, valid=?x?, blayout=col_major>
        %47 = pto.subview %23[%c16, %c0] sizes [16, 1] : !pto.tile_buf<vec, 32x1xf32, valid=?x?, blayout=col_major> -> !pto.tile_buf<vec, 16x1xf32, blayout=col_major>
