        ...
        scf.if %21 {
          ...
          scf.for %arg15 = %c0 to %c2 step %c1 {
            ...
            pto.vecscope {
              ...
              %60 = pto.vdup %cst, %59 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %61 = arith.index_cast %arg16 : i16 to index
                %62 = arith.muli %61, %c128 : index
                %result = pto.vlds %34[%62] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %63 = arith.addi %62, %c64 : index
                %result_3 = pto.vlds %34[%63] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %64 = pto.vmul %result, %60, %59 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %65 = pto.vmul %result_3, %60, %59 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %64, %22[%62], %58 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.vsts %65, %22[%63], %58 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            ...
            %37 = pto.alloc_tile addr = %c90880_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xf32, valid=?x?>
            pto.vecscope {
              ...
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %63 = arith.index_cast %arg16 : i16 to index
                %64 = arith.muli %63, %c128 : index
                %result_4 = pto.vlds %22[%64] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %65 = arith.addi %64, %c64 : index
                %result_5 = pto.vlds %22[%65] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %66 = pto.vadd %result_4, %result, %58 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %67 = pto.vadd %result_5, %result_3, %58 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %66, %22[%64], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.vsts %67, %22[%65], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              ...
              %60 = pto.pge_b32 "PAT_VL1" : !pto.mask<b32>
              %61 = pto.vdup %cst_2, %58 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
              %mask, %scalar_out = pto.plt_b32 %c1_i32 : i32 -> !pto.mask<b32>, i32
              %62 = pto.pand %60, %mask, %58 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %63 = arith.index_cast %arg16 : i16 to index
                %64 = arith.muli %63, %c128 : index
                %result_4 = pto.vlds %22[%64] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %65 = arith.addi %64, %c64 : index
                %result_5 = pto.vlds %22[%65] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %66 = pto.vmax %result_4, %result_5, %59 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %67 = pto.vcmax %66, %59 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %68 = pto.vmax %67, %61, %60 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %68, %23[%63], %62 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.candidate = "vmi_trowmax", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "trowmax"}
            }
            %38 = pto.alloc_tile addr = %c90880_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xf32, valid=?x?>
            pto.vecscope {
              %58 = pto.pset_b32 "PAT_ALL" : !pto.mask<b32>
              %59 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %60 = arith.index_cast %arg16 : i16 to index
                %result = pto.vlds %23[%60] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %61 = pto.vdup %result, %58 {position = "LOWEST"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %62 = arith.muli %60, %c128 : index
                %result_3 = pto.vlds %22[%62] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %63 = arith.addi %62, %c64 : index
                %result_4 = pto.vlds %22[%63] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %64 = pto.vsub %result_3, %61, %58 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %65 = pto.vsub %result_4, %61, %58 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %64, %22[%62], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.vsts %65, %22[%63], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            ...
            %39 = pto.alloc_tile addr = %c90880_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xf32, valid=?x?>
            pto.vecscope {
              %58 = pto.pset_b32 "PAT_ALL" : !pto.mask<b32>
              %59 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %63 = arith.index_cast %arg16 : i16 to index
                %64 = arith.muli %63, %c128 : index
                %result = pto.vlds %22[%64] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %65 = arith.addi %64, %c64 : index
                %result_3 = pto.vlds %22[%65] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %66 = pto.vexp %result, %58 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %67 = pto.vexp %result_3, %58 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %66, %22[%64], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.vsts %67, %22[%65], %59 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.candidate = "vmi_texp_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "texp"}
              %60 = pto.vdup %cst_0, %58 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
              %61 = pto.pge_b32 "PAT_VL1" : !pto.mask<b32>
              %mask, %scalar_out = pto.plt_b32 %c1_i32 : i32 -> !pto.mask<b32>, i32
              %62 = pto.pand %61, %mask, %58 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                %63 = arith.index_cast %arg16 : i16 to index
                %64 = arith.muli %63, %c128 : index
                %result = pto.vlds %22[%64] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %65 = arith.addi %64, %c64 : index
                %result_3 = pto.vlds %22[%65] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %66 = pto.vadd %result, %result_3, %59 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %67 = pto.vcadd %66, %59 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %68 = pto.vadd %67, %60, %61 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %68, %24[%63], %62 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.candidate = "vmi_trowsum", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "trowsum"}
            }
            %40 = pto.alloc_tile addr = %c90880_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xbf16, valid=?x?>
            pto.vecscope {
              %58 = pto.pset_b32 "PAT_ALL" : !pto.mask<b32>
              %59 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
              scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
                ...
                %result = pto.vlds %22[%61] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %62 = arith.addi %61, %c64 : index
                %result_3 = pto.vlds %22[%62] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %63 = pto.vcvt %result, %58 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
                %64 = pto.vcvt %result_3, %58 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
                pto.vsts %63, %25[%61], %59 {dist = "PK_B32"} : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b32>
                pto.vsts %64, %25[%62], %59 {dist = "PK_B32"} : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b32>
              } {pto.tilelib.candidate = "vmi_tcvt", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcvt"}
            }
            %41 = pto.alloc_tile addr = %c82688_i64 valid_row = %c32 valid_col = %c128 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>
            pto.vecscope {
              %58 = pto.castptr %c82688_i64 : i64 -> !pto.ptr<bf16, ub>
              %59 = pto.pge_b16 "PAT_ALL" : !pto.mask<b16>
              %60 = scf.for %arg16 = %c0_i16 to %c32_i16 step %c1_i16 iter_args(%arg17 = %58) -> (!pto.ptr<bf16, ub>)  : i16 {
                %61 = arith.index_cast %arg16 : i16 to index
                %62 = arith.muli %61, %c128 : index
                %result = pto.vlds %25[%62] : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
                %63 = pto.addptr %arg17, %c0 : <bf16, ub> -> <bf16, ub>
                %64 = pto.vsstb %result, %63, %c32_i16, %c1_i16, %59 : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, i16, i16, !pto.mask<b16> -> !pto.ptr<bf16, ub>
                scf.yield %64 : !pto.ptr<bf16, ub>
              } {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"}
            }
            pto.tpush(%41, %0 : !pto.tile_buf<vec, 32x128xbf16, valid=?x?, blayout=col_major, slayout=row_major>, !pto.pipe) {split = 0}
            %42 = arith.muli %arg15, %c2 : index
            %43 = arith.muli %arg15, %c160 : index
            %44 = arith.addi %13, %43 : index
            %45 = arith.addi %44, %26 : index
            %46 = pto.addptr %arg1, %45 : <f32, gm> -> <f32, gm>
            %47 = pto.addptr %46, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %27, %47, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            %48 = pto.addptr %arg0, %45 : <f32, gm> -> <f32, gm>
            %49 = pto.addptr %48, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %28, %49, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            %50 = arith.addi %42, %c1 : index
            %51 = arith.muli %50, %c80 : index
            %52 = arith.addi %13, %51 : index
            %53 = arith.addi %52, %26 : index
            %54 = pto.addptr %arg1, %53 : <f32, gm> -> <f32, gm>
            %55 = pto.addptr %54, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %30, %55, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
            %56 = pto.addptr %arg0, %53 : <f32, gm> -> <f32, gm>
            %57 = pto.addptr %56, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %32, %57, %c0_i64, %c1_i64, %c64_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
          }
        } else {
          %22 = pto.castptr %c90880_i64 : i64 -> !pto.ptr<f32, ub>
          pto.vecscope {
