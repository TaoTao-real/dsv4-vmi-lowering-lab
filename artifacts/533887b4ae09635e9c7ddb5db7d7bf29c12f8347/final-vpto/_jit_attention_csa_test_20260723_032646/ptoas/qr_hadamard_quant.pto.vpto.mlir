  ...
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<vector>, pto.target_arch = "a5"} {
    func.func @qr_hadamard_quant(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<i8, gm>, %arg3: i32, %arg4: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      scf.for %arg5 = %c0 to %c128 step %c64 {
        ...
        %15 = pto.alloc_tile addr = %c256_i64 valid_row = %c64 valid_col = %c64 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 64x64xf32, valid=?x?>
        pto.vecscope {
          %16 = pto.castptr %c256_i64 : i64 -> !pto.ptr<f32, ub>
          ...
          scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
            ...
            %result_4 = pto.vlds %4[%25] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %result_5 = pto.vlds %16[%25] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %26 = pto.vmax %result_4, %result_5, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %26, %16[%25], %17 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          } {pto.tilelib.candidate = "vmi_tmax", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmax"}
          %19 = pto.castptr %c49408_i64 : i64 -> !pto.ptr<f32, ub>
          %20 = pto.pge_b32 "PAT_VL1" : !pto.mask<b32>
          %21 = pto.vdup %cst, %18 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          %mask, %scalar_out = pto.plt_b32 %c1_i32 : i32 -> !pto.mask<b32>, i32
          %22 = pto.pand %20, %mask, %18 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
          scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
            %24 = arith.index_cast %arg6 : i16 to index
            %25 = arith.muli %24, %c64 : index
            %result_4 = pto.vlds %16[%25] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %26 = pto.vcmax %result_4, %17 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %27 = pto.vmax %26, %21, %20 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %27, %19[%24], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          ...
          %23 = pto.vmax %result, %result_3, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %23, %0[%c0], %17 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        }
      }
      pto.vecscope {
        %mask, %scalar_out = pto.plt_b32 %c64_i32 : i32 -> !pto.mask<b32>, i32
