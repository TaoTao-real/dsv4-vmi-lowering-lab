        ...
        scf.if %4 {
          ...
          scf.for %arg10 = %c0 to %c32 step %c1 {
            ...
            pto.vecscope {
              ...
              %39 = pto.vadd %result, %result_0, %38 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %40 = pto.pge_b32 "PAT_VL32" : !pto.mask<b32>
              %mask, %scalar_out = pto.plt_b32 %c32_i32 : i32 -> !pto.mask<b32>, i32
              %41 = pto.pand %40, %mask, %38 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
              pto.vsts %39, %16[%c0], %41 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            }
            ...
            pto.vecscope {
              ...
              %mask, %scalar_out = pto.plt_b32 %c32_i32 : i32 -> !pto.mask<b32>, i32
              %41 = pto.pand %40, %mask, %38 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
              pto.vsts %39, %13[%c0], %41 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            }
            %33 = pto.alloc_tile addr = %c256_i64 valid_row = %c1 valid_col = %c32 {__pto.force_dynamic_valid_shape} : !pto.tile_buf<vec, 1x32xf32, valid=?x?>
            pto.vecscope {
            ...
            %34 = arith.addi %19, %c1024 : index
            %35 = arith.addi %18, %34 : index
            %36 = pto.addptr %arg3, %35 : <f32, gm> -> <f32, gm>
            %37 = pto.addptr %36, %c0 : <f32, gm> -> <f32, gm>
            pto.copy_ubuf_to_gm %14, %37, %c0_i64, %c1_i64, %c128_i64, %c0_i64, %c0_i64, %c128_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
          }
        }
      }
      return
