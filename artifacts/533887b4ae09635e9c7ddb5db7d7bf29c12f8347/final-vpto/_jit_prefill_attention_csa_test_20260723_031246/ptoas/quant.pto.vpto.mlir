        ...
        scf.for %arg7 = %c0 to %c1024 step %c512 {
          ...
          pto.vecscope {
            scf.for %arg8 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
              ...
              %20 = scf.for %arg9 = %c0_i16 to %c512_i16 step %c64_i16 iter_args(%arg10 = %c512) -> (index)  : i16 {
          ...
          pto.vecscope {
            ...
            scf.for %arg8 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
              ...
              %result_6 = pto.vlds %2[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %29 = arith.addi %28, %c64 : index
              %result_7 = pto.vlds %2[%29] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %30 = arith.addi %28, %c128 : index
              %result_8 = pto.vlds %2[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %31 = arith.addi %28, %c192 : index
              %result_9 = pto.vlds %2[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %32 = arith.addi %28, %c256 : index
              %result_10 = pto.vlds %2[%32] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %33 = arith.addi %28, %c320 : index
              %result_11 = pto.vlds %2[%33] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %34 = arith.addi %28, %c384 : index
              %result_12 = pto.vlds %2[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %35 = arith.addi %28, %c448 : index
              %result_13 = pto.vlds %2[%35] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_14 = pto.vlds %4[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_15 = pto.vlds %4[%29] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_16 = pto.vlds %4[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_17 = pto.vlds %4[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_18 = pto.vlds %4[%32] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_19 = pto.vlds %4[%33] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_20 = pto.vlds %4[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_21 = pto.vlds %4[%35] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %36 = pto.vmax %result_6, %result_14, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %37 = pto.vmax %result_7, %result_15, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %38 = pto.vmax %result_8, %result_16, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %39 = pto.vmax %result_9, %result_17, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %40 = pto.vmax %result_10, %result_18, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %41 = pto.vmax %result_11, %result_19, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %42 = pto.vmax %result_12, %result_20, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %43 = pto.vmax %result_13, %result_21, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %36, %2[%28], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %37, %2[%29], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %38, %2[%30], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %39, %2[%31], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %40, %2[%32], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %41, %2[%33], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %42, %2[%34], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.vsts %43, %2[%35], %18 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            } {pto.tilelib.candidate = "vmi_tmax", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmax"}
            %20 = pto.castptr %c32800_i64 : i64 -> !pto.ptr<f32, ub>
            %21 = pto.pge_b32 "PAT_VL1" : !pto.mask<b32>
            %22 = pto.vdup %cst_2, %19 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
            %mask, %scalar_out = pto.plt_b32 %c1_i32 : i32 -> !pto.mask<b32>, i32
            %23 = pto.pand %21, %mask, %19 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
            scf.for %arg8 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
              %27 = arith.index_cast %arg8 : i16 to index
              %28 = arith.muli %27, %c512 : index
              %result_6 = pto.vlds %2[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              ...
              %35 = arith.addi %28, %c448 : index
              %result_13 = pto.vlds %2[%35] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %36 = pto.vmax %result_6, %result_7, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %37 = pto.vmax %36, %result_8, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %38 = pto.vmax %37, %result_9, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %39 = pto.vmax %38, %result_10, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %40 = pto.vmax %39, %result_11, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %41 = pto.vmax %40, %result_12, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %42 = pto.vmax %41, %result_13, %18 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %43 = pto.vcmax %42, %18 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %44 = pto.vmax %43, %22, %21 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %44, %20[%27], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            ...
            %result_3 = pto.vlds %20[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %25 = pto.vmax %result, %result_3, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %mask_4, %scalar_out_5 = pto.plt_b32 %c8_i32 : i32 -> !pto.mask<b32>, i32
            %26 = pto.pand %24, %mask_4, %19 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
            pto.vsts %25, %1[%c0], %26 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          }
        }
        pto.vecscope {
          %mask, %scalar_out = pto.plt_b32 %c8_i32 : i32 -> !pto.mask<b32>, i32
