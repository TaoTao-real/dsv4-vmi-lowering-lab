module attributes {pto.backend = "vpto", pto.target_arch = "a5"} {
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<cube>, pto.target_arch = "a5"} {
    func.func @qr_proj_matmul(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<bf16, gm>, %arg2: !pto.ptr<bf16, gm>, %arg3: index, %arg4: index, %arg5: index, %arg6: i32, %arg7: i32) attributes {pto.kernel_kind = #pto.kernel_kind<cube>} {
      %c8796093022224_i64 = arith.constant 8796093022224 : i64
      %c4398047561728_i64 = arith.constant 4398047561728 : i64
      ...
      scf.for %arg8 = %c0 to %5 step %c1 {
        ...
        scf.for %arg9 = %c0 to %c8 step %c2 {
          ...
          %43 = arith.muli %38, %c1024 : index
          %44 = arith.addi %43, %2 : index
          %45 = pto.addptr %arg2, %44 : <bf16, gm> -> <bf16, gm>
          pto.set_mte2_nz_para %c1099511693313_i64 : i64
          pto.copy_gm_to_cbuf_multi_nd2nz %45, %7, %c0_i64, %c2048_i64, %c0_i64, %c256_i64, %c128_i64, %c0_i64, %false : !pto.ptr<bf16, gm>, !pto.ptr<bf16, l1>, i64, i64, i64, i64, i64, i64, i1
          ...
          %48 = arith.muli %40, %c1024 : index
          %49 = arith.addi %48, %2 : index
          %50 = pto.addptr %arg2, %49 : <bf16, gm> -> <bf16, gm>
          pto.set_mte2_nz_para %c1099511693313_i64 : i64
          pto.copy_gm_to_cbuf_multi_nd2nz %50, %9, %c0_i64, %c2048_i64, %c0_i64, %c256_i64, %c128_i64, %c0_i64, %false : !pto.ptr<bf16, gm>, !pto.ptr<bf16, l1>, i64, i64, i64, i64, i64, i64, i1
        ...
        %34 = arith.muli %arg8, %c16384 : index
        ...
        pto.copy_matrix_cc_to_gm %14, %36, %c4398047561728_i64, %c8796093022224_i64 : !pto.ptr<f32, l0c>, !pto.ptr<f32, gm>, i64, i64
      }
      return
    }
  }
