    ...
    scf.for %arg5 = %c0 to %c32 step %c2 {
      ...
      %32 = pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          ...
          %45 = pto.vmi.vload %39[%43] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %46 = pto.vmi.vmul %44, %45, %42 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
          pto.vmi.vstore %46, %41[%43], %42 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
