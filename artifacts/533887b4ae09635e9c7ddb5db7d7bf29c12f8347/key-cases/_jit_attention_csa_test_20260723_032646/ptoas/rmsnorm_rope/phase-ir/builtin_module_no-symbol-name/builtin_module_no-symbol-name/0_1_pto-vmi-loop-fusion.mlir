    ...
    scf.for %arg5 = %c0 to %c128 step %c64 {
      ...
      %100 = pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c16 step %c1 {
          ...
          %111 = pto.vmi.vload %105[%109] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %112 = pto.vmi.vmul %110, %111, %108 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
          pto.vmi.vstore %112, %107[%109], %108 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
