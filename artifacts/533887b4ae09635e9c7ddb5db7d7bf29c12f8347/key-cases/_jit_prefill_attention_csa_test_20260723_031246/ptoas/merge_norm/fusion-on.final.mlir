        ...
        scf.if %3 {
          ...
          scf.for %arg10 = %c1 to %c3 step %c1 {
            ...
            pto.vecscope {
              ...
              %35 = pto.castptr %c33088_i64 : i64 -> !pto.ptr<f32, ub>
              %result_2 = pto.vlds %14[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_3 = pto.vlds %30[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %36 = pto.vsub %result_2, %result_3, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %36, %35[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %37 = pto.castptr %c32896_i64 : i64 -> !pto.ptr<f32, ub>
              %result_4 = pto.vlds %35[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %38 = pto.vexp %result_4, %32 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %38, %37[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %result_5 = pto.vlds %20[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_6 = pto.vlds %30[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %39 = pto.vsub %result_5, %result_6, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %39, %35[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %40 = pto.castptr %c32960_i64 : i64 -> !pto.ptr<f32, ub>
              %result_7 = pto.vlds %35[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %41 = pto.vexp %result_7, %32 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %41, %40[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %result_8 = pto.vlds %37[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_9 = pto.vlds %16[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %42 = pto.vmul %result_8, %result_9, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %42, %35[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %43 = pto.castptr %c33024_i64 : i64 -> !pto.ptr<f32, ub>
              %result_10 = pto.vlds %40[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_11 = pto.vlds %21[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %44 = pto.vmul %result_10, %result_11, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %44, %43[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %result_12 = pto.vlds %35[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %result_13 = pto.vlds %43[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %45 = pto.vadd %result_12, %result_13, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %45, %43[%c0], %34 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              scf.for %arg11 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
                %51 = arith.index_cast %arg11 : i16 to index
                %52 = arith.muli %51, %c512 : index
                %53 = pto.addptr %37, %51 : <f32, ub> -> <f32, ub>
                %54 = scf.for %arg12 = %c0_i16 to %c512_i16 step %c64_i16 iter_args(%arg13 = %c512) -> (index)  : i16 {
                  ...
                  %result_19 = pto.vlds %53[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                  %60 = pto.vdup %result_19, %mask_16 {position = "LOWEST"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %61 = pto.vmul %result_18, %60, %mask_16 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %62 = pto.addptr %35, %58 : <f32, ub> -> <f32, ub>
              ...
              scf.for %arg11 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
                %51 = arith.index_cast %arg11 : i16 to index
                %52 = arith.muli %51, %c512 : index
                %53 = pto.addptr %40, %51 : <f32, ub> -> <f32, ub>
                %54 = scf.for %arg12 = %c0_i16 to %c512_i16 step %c64_i16 iter_args(%arg13 = %c512) -> (index)  : i16 {
                  %55 = arith.index_cast %arg12 : i16 to index
                  %56 = arith.index_cast %arg13 : index to i32
                  %mask_16, %scalar_out_17 = pto.plt_b32 %56 : i32 -> !pto.mask<b32>, i32
                  ...
                  %60 = pto.vdup %result_19, %mask_16 {position = "LOWEST"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  %61 = pto.vmul %result_18, %60, %mask_16 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                  pto.vsts %61, %59[%c0], %mask_16 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                  scf.yield %57 : index
                }
              } {pto.tilelib.candidate = "template_trowexpandmul", pto.tilelib.impl = "ptodsl", pto.vmi.fusion.boundary = "local", pto.vmi.fusion.boundary_reason = "non_vmi_local_boundary_fallback", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "trowexpandmul"}
              ...
              scf.for %arg11 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
                %51 = arith.index_cast %arg11 : i16 to index
                %52 = arith.muli %51, %c512 : index
                %result_16 = pto.vlds %35[%52] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %53 = arith.addi %52, %c64 : index
                %result_17 = pto.vlds %35[%53] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %54 = arith.addi %52, %c128 : index
                %result_18 = pto.vlds %35[%54] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %55 = arith.addi %52, %c192 : index
                %result_19 = pto.vlds %35[%55] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %56 = arith.addi %52, %c256 : index
                %result_20 = pto.vlds %35[%56] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %57 = arith.addi %52, %c320 : index
                %result_21 = pto.vlds %35[%57] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %58 = arith.addi %52, %c384 : index
                %result_22 = pto.vlds %35[%58] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %59 = arith.addi %52, %c448 : index
                %result_23 = pto.vlds %35[%59] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_24 = pto.vlds %22[%52] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_25 = pto.vlds %22[%53] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_26 = pto.vlds %22[%54] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_27 = pto.vlds %22[%55] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_28 = pto.vlds %22[%56] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_29 = pto.vlds %22[%57] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_30 = pto.vlds %22[%58] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_31 = pto.vlds %22[%59] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %60 = pto.vadd %result_16, %result_24, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %61 = pto.vadd %result_17, %result_25, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %62 = pto.vadd %result_18, %result_26, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %63 = pto.vadd %result_19, %result_27, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %64 = pto.vadd %result_20, %result_28, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %65 = pto.vadd %result_21, %result_29, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %66 = pto.vadd %result_22, %result_30, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %67 = pto.vadd %result_23, %result_31, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              ...
              %47 = pto.addptr %43, %c0 : <f32, ub> -> <f32, ub>
              %result_14 = pto.vlds %47[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %48 = pto.addptr %16, %c0 : <f32, ub> -> <f32, ub>
              pto.vsts %result_14, %48[%c0], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %49 = pto.addptr %30, %c0 : <f32, ub> -> <f32, ub>
              %result_15 = pto.vlds %49[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %50 = pto.addptr %14, %c0 : <f32, ub> -> <f32, ub>
              pto.vsts %result_15, %50[%c0], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            }
          }
          ...
          pto.vecscope {
            ...
            %result_1 = pto.vlds %24[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %result_2 = pto.vlds %22[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %29 = pto.vadd %result_1, %result_2, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %29, %22[%c0], %28 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            %result_3 = pto.vlds %22[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %result_4 = pto.vlds %14[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %30 = pto.vsub %result_3, %result_4, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %30, %22[%c0], %28 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            %result_5 = pto.vlds %22[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %31 = pto.vexp %result_5, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %31, %22[%c0], %28 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            %result_6 = pto.vlds %16[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %result_7 = pto.vlds %22[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %32 = pto.vadd %result_6, %result_7, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            ...
            scf.for %arg10 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
              ...
              %38 = scf.for %arg11 = %c0_i16 to %c512_i16 step %c64_i16 iter_args(%arg12 = %c512) -> (index)  : i16 {
                ...
                %mask_8, %scalar_out_9 = pto.plt_b32 %40 : i32 -> !pto.mask<b32>, i32
                %41 = arith.index_cast %scalar_out_9 : i32 to index
                %42 = arith.addi %36, %39 : index
                %43 = pto.addptr %19, %42 : <f32, ub> -> <f32, ub>
                %result_10 = pto.vlds %43[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_11 = pto.vlds %37[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %44 = pto.vdup %result_11, %mask_8 {position = "LOWEST"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                %45 = pto.vdiv %result_10, %44, %mask_8 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %45, %43[%c0], %mask_8 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                scf.yield %41 : index
              }
            ...
            scf.for %arg10 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
              %35 = arith.index_cast %arg10 : i16 to index
              %36 = arith.muli %35, %c512 : index
              %result_8 = pto.vlds %19[%36] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %37 = arith.addi %36, %c64 : index
              %result_9 = pto.vlds %19[%37] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %38 = arith.addi %36, %c128 : index
              %result_10 = pto.vlds %19[%38] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %39 = arith.addi %36, %c192 : index
              %result_11 = pto.vlds %19[%39] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %40 = arith.addi %36, %c256 : index
              %result_12 = pto.vlds %19[%40] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %41 = arith.addi %36, %c320 : index
              %result_13 = pto.vlds %19[%41] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %42 = arith.addi %36, %c384 : index
              %result_14 = pto.vlds %19[%42] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %43 = arith.addi %36, %c448 : index
              %result_15 = pto.vlds %19[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %44 = pto.vcvt %result_8, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %45 = pto.vcvt %result_9, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %46 = pto.vcvt %result_10, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %47 = pto.vcvt %result_11, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %48 = pto.vcvt %result_12, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %49 = pto.vcvt %result_13, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %50 = pto.vcvt %result_14, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %51 = pto.vcvt %result_15, %26 {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
