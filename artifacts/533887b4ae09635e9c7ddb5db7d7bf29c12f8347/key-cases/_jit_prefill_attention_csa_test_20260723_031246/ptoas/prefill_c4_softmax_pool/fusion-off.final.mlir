          ...
          scf.if %21 {
            ...
            scf.if %23 {
              ...
              %25:2 = scf.if %24 -> (index, index) {
                %40 = arith.subi %22, %11 : index
                scf.yield %4, %40 : index, index
              } else {
                %40 = arith.subi %22, %10 : index
                %41 = arith.addi %40, %c4 : index
                %42 = arith.addi %4, %c512 : index
              ...
              pto.vecscope {
                %40 = scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16 iter_args(%arg14 = %c256) -> (index)  : i16 {
                  ...
                  %46 = pto.vadd %result, %result_1, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
