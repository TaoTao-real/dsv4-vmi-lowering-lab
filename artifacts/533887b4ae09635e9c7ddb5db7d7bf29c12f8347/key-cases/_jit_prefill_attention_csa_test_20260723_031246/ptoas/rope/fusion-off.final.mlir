    ...
    func.func @rope(%arg0: !pto.ptr<bf16, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          %21 = arith.index_cast %arg6 : i16 to index
          %22 = arith.muli %21, %c32 : index
          %23 = pto.addptr %6, %22 : <i32, ub> -> <i32, ub>
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          ...
          %23 = pto.addptr %5, %22 : <f32, ub> -> <f32, ub>
          %result_2 = pto.vlds %23[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %24 = pto.addptr %7, %22 : <f32, ub> -> <f32, ub>
        ...
        %20 = pto.castptr %c24832_i64 : i64 -> !pto.ptr<i32, ub>
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          %21 = arith.index_cast %arg6 : i16 to index
          %22 = arith.muli %21, %c32 : index
          %23 = pto.addptr %5, %22 : <f32, ub> -> <f32, ub>
        ...
        scf.for %arg7 = %c0 to %c32 step %c16 {
          ...
          pto.vecscope {
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              pto.vsts %51, %41[%c0], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              %46 = pto.addptr %11, %44 : <f32, ub> -> <f32, ub>
              %result_2 = pto.vlds %46[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %47 = pto.vmul %result, %result_2, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              %43 = arith.index_cast %arg8 : i16 to index
              %44 = arith.muli %43, %c32 : index
              %45 = pto.addptr %42, %44 : <f32, ub> -> <f32, ub>
              %result = pto.vlds %45[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %46 = pto.addptr %13, %44 : <f32, ub> -> <f32, ub>
              %result_2 = pto.vlds %46[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %47 = pto.vmul %result, %result_2, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              %48 = pto.addptr %11, %44 : <f32, ub> -> <f32, ub>
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              %46 = pto.addptr %11, %44 : <f32, ub> -> <f32, ub>
              %result_2 = pto.vlds %46[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %47 = pto.vadd %result, %result_2, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %47, %45[%c0], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              %45 = pto.addptr %7, %44 : <f32, ub> -> <f32, ub>
              %result = pto.vlds %45[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %46 = pto.vcvt %result, %mask {part = "EVEN", rnd = "R", sat = "SAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<128xbf16>
              %47 = pto.addptr %15, %44 : <bf16, ub> -> <bf16, ub>
              pto.vsts %46, %47[%c0], %mask {dist = "PK_B32"} : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b32>
