...
func.func @rope(%arg0: !pto.ptr<bf16, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  %16 = pto.fusion_region {
    %22 = pto.alloc_tile addr = %c33024_i64 valid_row = %c64 valid_col = %c32 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
    pto.tmuls ins(%15, %cst_1 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>, f32) outs(%22 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmuls", postupdate = 0 : i64, tags = ["elementwise", "scalar"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmuls", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmuls", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%22) : (!pto.tile_buf<vec, 64x32xf32, valid=?x?>) -> ()
  } {pto.fusion.group_id = 2 : i64} : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
  %17 = pto.fusion_region {
    %22 = pto.alloc_tile addr = %c33024_i64 valid_row = %c64 valid_col = %c32 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
    pto.tsub ins(%12, %16 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>, !pto.tile_buf<vec, 64x32xf32, valid=?x?>) outs(%22 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tsub", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tsub", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tsub", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%22) : (!pto.tile_buf<vec, 64x32xf32, valid=?x?>) -> ()
  } {pto.fusion.group_id = 3 : i64} : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
  %18 = pto.fusion_region {
    %22 = pto.alloc_tile addr = %c24832_i64 valid_row = %c64 valid_col = %c32 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
    pto.tadds ins(%12, %cst : !pto.tile_buf<vec, 64x32xf32, valid=?x?>, f32) outs(%22 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tadds", postupdate = 0 : i64, tags = ["elementwise", "scalar"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tadds", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tadds", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%22) : (!pto.tile_buf<vec, 64x32xf32, valid=?x?>) -> ()
  } {pto.fusion.group_id = 4 : i64} : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
  %19 = pto.fusion_region {
    %22 = pto.alloc_tile addr = %c33024_i64 valid_row = %c64 valid_col = %c32 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
    pto.tmuls ins(%17, %cst_1 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>, f32) outs(%22 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tmuls", postupdate = 0 : i64, tags = ["elementwise", "scalar"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmuls", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tmuls", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%22) : (!pto.tile_buf<vec, 64x32xf32, valid=?x?>) -> ()
  } {pto.fusion.group_id = 5 : i64} : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
  %20 = pto.fusion_region {
    %22 = pto.alloc_tile addr = %c24832_i64 valid_row = %c64 valid_col = %c32 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>
    pto.tsub ins(%18, %19 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>, !pto.tile_buf<vec, 64x32xf32, valid=?x?>) outs(%22 : !pto.tile_buf<vec, 64x32xf32, valid=?x?>) {candidates = [{id = 0 : i64, loop_depth = 2 : i64, name = "template_tsub", postupdate = 0 : i64, tags = ["elementwise", "binary"], tail = 0 : i64}, {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tsub", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}], pto.tilelib.impl = "vmi", pto.tilelib.selected_candidate = {id = 1000 : i64, loop_depth = 1 : i64, name = "vmi_tsub", postupdate = 0 : i64, tags = ["vmi", "fusion_eligible", "single_logical_row_loop"], tail = 0 : i64}}
    pto.yield(%22) : (!pto.tile_buf<vec, 64x32xf32, valid=?x?>) -> ()
