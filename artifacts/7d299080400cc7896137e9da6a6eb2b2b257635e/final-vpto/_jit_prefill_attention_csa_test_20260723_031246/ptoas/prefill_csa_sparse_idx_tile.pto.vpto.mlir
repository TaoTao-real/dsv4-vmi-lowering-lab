  ...
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<vector>, pto.target_arch = "a5"} {
    func.func @prefill_csa_sparse_idx_tile(%arg0: !pto.ptr<i32, gm>, %arg1: !pto.ptr<i32, gm>, %arg2: !pto.ptr<i32, gm>, %arg3: !pto.ptr<i32, gm>, %arg4: !pto.ptr<i32, gm>, %arg5: index, %arg6: i32, %arg7: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      scf.for %arg8 = %c0 to %c2 step %c1 {
        ...
        pto.vecscope {
          %16 = scf.for %arg9 = %c0_i16 to %c128_i16 step %c64_i16 iter_args(%arg10 = %c128) -> (index)  : i16 {
            %17 = arith.index_cast %arg9 : i16 to index
            %18 = arith.index_cast %arg10 : index to i32
            %mask, %scalar_out = pto.plt_b32 %18 : i32 -> !pto.mask<b32>, i32
            %19 = arith.index_cast %scalar_out : i32 to index
            %20 = pto.vdup %c-1_i32, %mask : i32, !pto.mask<b32> -> !pto.vreg<64xi32>
            %21 = pto.addptr %2, %17 : <i32, ub> -> <i32, ub>
            pto.vsts %20, %21[%c0], %mask : !pto.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.mask<b32>
            scf.yield %19 : index
          }
        }
        ...
        pto.vecscope {
          %16 = scf.for %arg9 = %c0_i16 to %c512_i16 step %c64_i16 iter_args(%arg10 = %c512) -> (index)  : i16 {
            %17 = arith.index_cast %arg9 : i16 to index
            %18 = arith.index_cast %arg10 : index to i32
            %mask, %scalar_out = pto.plt_b32 %18 : i32 -> !pto.mask<b32>, i32
            %19 = arith.index_cast %scalar_out : i32 to index
            %20 = pto.vdup %c-1_i32, %mask : i32, !pto.mask<b32> -> !pto.vreg<64xi32>
            %21 = pto.addptr %3, %17 : <i32, ub> -> <i32, ub>
            pto.vsts %20, %21[%c0], %mask : !pto.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.mask<b32>
            scf.yield %19 : index
          }
        }
