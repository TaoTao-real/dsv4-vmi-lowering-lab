      ...
      scf.if %4 {
        ...
        scf.if %7 {
          ...
          pto.vecscope {
            ...
            %42 = pto.vmul %result, %41, %40 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %42, %17[%c0], %39 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          }
          ...
          pto.vecscope {
            ...
            %40 = pto.vadd %result, %result_0, %39 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %41 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
            pto.vsts %40, %24[%c0], %41 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          }
          ...
          pto.vecscope {
            ...
            %40 = pto.vadd %result, %result_0, %39 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %41 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
            pto.vsts %40, %14[%c0], %41 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          }
          ...
          %35 = arith.addi %3, %c256 : index
          %36 = arith.addi %28, %35 : index
          %37 = pto.addptr %arg5, %36 : <f32, gm> -> <f32, gm>
          %38 = pto.addptr %37, %c0 : <f32, gm> -> <f32, gm>
          pto.copy_ubuf_to_gm %16, %38, %c0_i64, %c1_i64, %c256_i64, %c0_i64, %c0_i64, %c256_i64 : !pto.ptr<f32, ub>, !pto.ptr<f32, gm>, i64, i64, i64, i64, i64, i64
        }
      }
      return
    }
