  ...
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<vector>, pto.target_arch = "a5"} {
    func.func @prefill_idx_weights_proj_aiv(%arg0: !pto.ptr<bf16, gm>, %arg1: !pto.ptr<bf16, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: i32, %arg4: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        %13 = pto.vdup %cst, %12 : f32, !pto.mask<b32> -> !pto.vreg<64xf32>
        scf.for %arg5 = %c0_i16 to %c32_i16 step %c1_i16  : i16 {
          %14 = arith.index_cast %arg5 : i16 to index
          %15 = arith.muli %14, %c64 : index
          %result = pto.vlds %3[%15] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %16 = pto.vmul %result, %13, %12 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %16, %6[%15], %11 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
