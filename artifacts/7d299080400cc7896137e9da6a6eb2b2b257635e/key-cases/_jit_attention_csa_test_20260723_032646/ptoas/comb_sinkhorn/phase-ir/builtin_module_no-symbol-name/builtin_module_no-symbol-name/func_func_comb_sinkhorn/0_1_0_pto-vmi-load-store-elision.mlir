...
func.func @comb_sinkhorn(%arg0: memref<?xf32, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xf32, #pto.address_space<gm>>, %arg4: f32, %arg5: index, %arg6: i32, %arg7: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  %69:4 = pto.fusion_region {
    ...
    scf.for %arg8 = %c0 to %c8 step %c1 {
      ...
      %192 = pto.vmi.vexp %191, %119 : !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %192, %118[%189], %119 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %193 = pto.vmi.vload %123[%arg8] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<1xf32>
      %194 = pto.vmi.vbrc %193 : !pto.vmi.vreg<1xf32> -> !pto.vmi.vreg<8xf32>
      %195 = pto.vmi.vload %121[%189] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %196 = pto.vmi.vsub %195, %194, %114 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      %197 = pto.vmi.vexp %196, %119 : !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %197, %129[%189], %119 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %198 = pto.vmi.vload %133[%arg8] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<1xf32>
      %199 = pto.vmi.vbrc %198 : !pto.vmi.vreg<1xf32> -> !pto.vmi.vreg<8xf32>
      %200 = pto.vmi.vload %131[%189] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %201 = pto.vmi.vsub %200, %199, %114 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      %202 = pto.vmi.vexp %201, %119 : !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %202, %139[%189], %119 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %203 = pto.vmi.vload %143[%arg8] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<1xf32>
      %204 = pto.vmi.vbrc %203 : !pto.vmi.vreg<1xf32> -> !pto.vmi.vreg<8xf32>
      %205 = pto.vmi.vload %141[%189] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %206 = pto.vmi.vsub %205, %204, %114 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      %207 = pto.vmi.vexp %206, %119 : !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %207, %149[%189], %119 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
  ...
  %78:4 = pto.fusion_region {
    ...
    scf.for %arg8 = %c0 to %c8 step %c1 {
      ...
      %165 = pto.vmi.vload %116[%161] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %166 = pto.vmi.vload %118[%161] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %167 = pto.vmi.vadd %165, %166, %114 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %167, %120[%161], %114 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %168 = pto.vmi.vadd %164, %167, %114 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      %169 = pto.vmi.vadds %168, %cst_1, %131 : !pto.vmi.vreg<8xf32>, f32, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %169, %130[%161], %131 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
  ...
  scf.for %arg8 = %c0 to %c18 step %c2 {
    ...
    pto.fusion_region {
      ...
      scf.for %arg9 = %c0 to %c8 step %c1 {
        ...
        %287 = pto.vmi.vload %157[%283] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
        %288 = pto.vmi.vload %159[%283] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
        %289 = pto.vmi.vadd %287, %288, %155 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %289, %161[%283], %155 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %290 = pto.vmi.vadd %286, %289, %155 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        %291 = pto.vmi.vadds %290, %cst_1, %116 : !pto.vmi.vreg<8xf32>, f32, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %291, %171[%283], %116 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %292 = pto.vmi.vdiv %284, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %292, %177[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %293 = pto.vmi.vdiv %285, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %293, %184[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %294 = pto.vmi.vdiv %287, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %294, %190[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %295 = pto.vmi.vdiv %288, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %295, %196[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      ...
      scf.for %arg9 = %c0 to %c8 step %c1 {
        ...
        %286 = pto.vmi.vadd %284, %285, %155 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        %287 = pto.vmi.vload %244[%283] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
        %288 = pto.vmi.vload %246[%283] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
        %289 = pto.vmi.vadd %287, %288, %155 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %289, %248[%283], %155 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %290 = pto.vmi.vadd %286, %289, %155 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %290, %254[%283], %155 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %291 = pto.vmi.vadds %290, %cst_1, %116 : !pto.vmi.vreg<8xf32>, f32, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %291, %258[%283], %116 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %292 = pto.vmi.vdiv %284, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %292, %264[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %293 = pto.vmi.vdiv %285, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %293, %270[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %294 = pto.vmi.vdiv %287, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %294, %276[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
        %295 = pto.vmi.vdiv %288, %291, %178 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
        pto.vmi.vstore %295, %282[%283], %178 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      pto.yield() : () -> ()
  ...
  pto.fusion_region {
    ...
    scf.for %arg8 = %c0 to %c8 step %c1 {
      ...
      %197 = pto.vmi.vload %153[%193] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %198 = pto.vmi.vload %155[%193] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<8xf32>
      %199 = pto.vmi.vadd %197, %198, %151 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %199, %157[%193], %151 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %200 = pto.vmi.vadd %196, %199, %151 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      %201 = pto.vmi.vadds %200, %cst_1, %112 : !pto.vmi.vreg<8xf32>, f32, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %201, %167[%193], %112 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %202 = pto.vmi.vdiv %194, %201, %174 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %202, %173[%193], %174 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %203 = pto.vmi.vdiv %195, %201, %174 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %203, %180[%193], %174 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %204 = pto.vmi.vdiv %197, %201, %174 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %204, %186[%193], %174 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
      %205 = pto.vmi.vdiv %198, %201, %174 : !pto.vmi.vreg<8xf32>, !pto.vmi.vreg<8xf32>, !pto.vmi.mask<8xpred> -> !pto.vmi.vreg<8xf32>
      pto.vmi.vstore %205, %192[%193], %174 : !pto.vmi.vreg<8xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<8xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    pto.yield() : () -> ()
