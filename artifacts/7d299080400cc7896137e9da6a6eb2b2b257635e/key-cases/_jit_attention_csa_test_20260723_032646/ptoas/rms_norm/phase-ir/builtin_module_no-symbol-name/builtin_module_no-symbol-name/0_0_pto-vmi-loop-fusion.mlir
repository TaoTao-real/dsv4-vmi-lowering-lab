  ...
  func.func @rms_norm(%arg0: memref<?xbf16, #pto.address_space<gm>>, %arg1: memref<?xbf16, #pto.address_space<gm>>, %arg2: memref<?xbf16, #pto.address_space<gm>>, %arg3: i32, %arg4: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.for %arg5 = %c0 to %c32 step %c2 {
      ...
      pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %73 = arith.muli %arg6, %c128 : index
          %74 = pto.vmi.vload %39[%73] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %75 = pto.vmi.vcadd %74, %42 {reassoc} : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<1xf32>
          pto.vmi.vstore %75, %41[%arg6], %43 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
        ...
        scf.for %arg6 = %c0 to %c8 step %c1 {
          %73 = arith.muli %arg6, %c128 : index
          %74 = pto.vmi.vload %61[%73] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<128xf32>
          %75 = pto.vmi.vcadd %74, %42 {reassoc} : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<1xf32>
          pto.vmi.vstore %75, %63[%arg6], %43 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
        } {pto.tilelib.candidate = "vmi_trowsum", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "trowsum"}
