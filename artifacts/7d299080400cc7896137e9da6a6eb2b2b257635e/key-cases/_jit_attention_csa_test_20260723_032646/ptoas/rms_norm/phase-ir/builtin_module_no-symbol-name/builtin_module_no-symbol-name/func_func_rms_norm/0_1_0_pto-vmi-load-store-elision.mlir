  ...
  scf.for %arg5 = %c0 to %c32 step %c2 {
    ...
    pto.fusion_region {
      ...
      scf.for %arg6 = %c0 to %c8 step %c1 {
        ...
        %75 = pto.vmi.vmul %74, %74, %37 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
        pto.vmi.vstore %75, %36[%73], %37 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        %76 = pto.vmi.vcadd %75, %42 {reassoc} : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<1xf32>
        pto.vmi.vstore %76, %41[%arg6], %43 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
      ...
      scf.for %arg6 = %c0 to %c8 step %c1 {
        ...
        %75 = pto.vmi.vmul %74, %74, %37 : !pto.vmi.vreg<128xf32>, !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<128xf32>
        pto.vmi.vstore %75, %59[%73], %37 : !pto.vmi.vreg<128xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<128xpred>
        %76 = pto.vmi.vcadd %75, %42 {reassoc} : !pto.vmi.vreg<128xf32>, !pto.vmi.mask<128xpred> -> !pto.vmi.vreg<1xf32>
        pto.vmi.vstore %76, %63[%arg6], %43 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
      } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
