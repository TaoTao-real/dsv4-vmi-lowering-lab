  ...
  func.func @rmsnorm_rope(%arg0: memref<?xf32, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xbf16, #pto.address_space<gm>>, %arg4: memref<?xbf16, #pto.address_space<gm>>) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.for %arg5 = %c0 to %c128 step %c64 {
      ...
      pto.fusion_region {
        ...
        scf.for %arg6 = %c0 to %c16 step %c1 {
          %110 = arith.muli %arg6, %c64 : index
          %111 = pto.vmi.vload %95[%110] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
          %112 = pto.vmi.vcadd %111, %98 {reassoc} : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<1xf32>
          pto.vmi.vstore %112, %97[%arg6], %99 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
        } {pto.tilelib.candidate = "vmi_trowsum", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "trowsum"}
    ...
    %74:3 = pto.fusion_region {
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %129 = arith.muli %arg5, %c64 : index
        %130 = pto.vmi.vload %90[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %131 = pto.vmi.vmuls %130, %cst_0, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %131, %92[%129], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %129 = arith.muli %arg5, %c64 : index
        %130 = pto.vmi.vload %101[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %131 = pto.vmi.vload %103[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %132 = pto.vmi.vsub %130, %131, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %132, %105[%129], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %129 = arith.muli %arg5, %c64 : index
        %130 = pto.vmi.vload %108[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %131 = pto.vmi.vadds %130, %cst_1, %111 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %131, %110[%129], %111 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %129 = arith.muli %arg5, %c64 : index
        %130 = pto.vmi.vload %113[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %131 = pto.vmi.vmuls %130, %cst, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %131, %115[%129], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmuls", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmuls"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %129 = arith.muli %arg5, %c64 : index
        %130 = pto.vmi.vload %117[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %131 = pto.vmi.vload %119[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %132 = pto.vmi.vsub %130, %131, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %132, %121[%129], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tsub", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tsub"}
    ...
    %75 = pto.fusion_region {
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %113 = arith.muli %arg5, %c64 : index
        %114 = pto.vmi.vload %89[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %115 = pto.vmi.vload %91[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %116 = pto.vmi.vmul %114, %115, %87 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %116, %93[%113], %87 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
      %94 = pto.pointer_cast(%c0_i64) %c16, %c64 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<16x64xf32, #pto.address_space<vec>>
      %95 = pto.castptr %94 : memref<16x64xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %113 = arith.muli %arg5, %c64 : index
        %114 = pto.vmi.vload %95[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %115 = pto.vmi.vload %97[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %116 = pto.vmi.vmul %114, %115, %87 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %116, %99[%113], %87 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      } {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"}
      ...
      scf.for %arg5 = %c0 to %c16 step %c1 {
        %113 = arith.muli %arg5, %c64 : index
        %114 = pto.vmi.vload %101[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %115 = pto.vmi.vload %103[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
        %116 = pto.vmi.vadd %114, %115, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %116, %105[%113], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
