...
func.func @rmsnorm_rope(%arg0: memref<?xf32, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xbf16, #pto.address_space<gm>>, %arg4: memref<?xbf16, #pto.address_space<gm>>) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  scf.for %arg5 = %c0 to %c128 step %c64 {
    ...
    pto.fusion_region {
      ...
      scf.for %arg6 = %c0 to %c16 step %c1 {
        ...
        %112 = pto.vmi.vmul %111, %111, %93 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
        pto.vmi.vstore %112, %92[%110], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
        %113 = pto.vmi.vcadd %112, %98 {reassoc} : !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<1xf32>
        pto.vmi.vstore %113, %97[%arg6], %99 : !pto.vmi.vreg<1xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<1xpred>
  ...
  pto.fusion_region {
    ...
    %93 = pto.vmi.vadds %87, %cst_2, %92 : !pto.vmi.vreg<16xf32>, f32, !pto.vmi.mask<16xpred> -> !pto.vmi.vreg<16xf32>
    pto.vmi.vstore %93, %91[%c0], %92 : !pto.vmi.vreg<16xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<16xpred>
    pto.yield() : () -> ()
  ...
  %74:3 = pto.fusion_region {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      %132 = pto.vmi.vmuls %131, %cst_0, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %132, %92[%129], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    scf.for %arg5 = %c0 to %c16 step %c1 {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      %132 = pto.vmi.vload %101[%129] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %133 = pto.vmi.vsub %132, %131, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %133, %105[%129], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %134 = pto.vmi.vadds %132, %cst_1, %111 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      %135 = pto.vmi.vmuls %133, %cst, %93 : !pto.vmi.vreg<64xf32>, f32, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %135, %115[%129], %93 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %136 = pto.vmi.vsub %134, %135, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %136, %121[%129], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
  ...
  %75 = pto.fusion_region {
    ...
    scf.for %arg5 = %c0 to %c16 step %c1 {
      ...
      %117 = pto.vmi.vload %89[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %118 = pto.vmi.vload %91[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %119 = pto.vmi.vmul %117, %118, %87 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      %120 = pto.vmi.vload %97[%113] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<64xf32>
      %121 = pto.vmi.vmul %119, %120, %87 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %121, %99[%113], %87 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
      %122 = pto.vmi.vadd %116, %121, %106 : !pto.vmi.vreg<64xf32>, !pto.vmi.vreg<64xf32>, !pto.vmi.mask<64xpred> -> !pto.vmi.vreg<64xf32>
      pto.vmi.vstore %122, %105[%113], %106 : !pto.vmi.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<64xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
