            ...
            scf.if %16 {
              ...
              scf.if %21 {
                ...
                pto.vecscope {
                  ...
                  %30 = scf.for %arg10 = %c0_i16 to %c512_i16 step %c128_i16 iter_args(%arg11 = %c512) -> (index)  : i16 {
                    %31 = arith.index_cast %arg10 : i16 to index
                    %32 = arith.index_cast %arg11 : index to i32
                    %mask, %scalar_out = pto.plt_b16 %32 : i32 -> !pto.mask<b16>, i32
                    %33 = arith.index_cast %scalar_out : i32 to index
                    %34 = pto.addptr %24, %31 : <bf16, ub> -> <bf16, ub>
                    %result = pto.vlds %34[%c0] : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
                    %35 = pto.addptr %29, %31 : <bf16, ub> -> <bf16, ub>
                    pto.vsts %result, %35[%c0], %mask : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b16>
                    scf.yield %33 : index
                  }
                }
              }
              ...
              scf.if %18 {
                ...
                scf.if %23 {
                  ...
                  pto.vecscope {
                    ...
                    %39 = scf.for %arg10 = %c0_i16 to %c512_i16 step %c128_i16 iter_args(%arg11 = %c512) -> (index)  : i16 {
                      %40 = arith.index_cast %arg10 : i16 to index
                      %41 = arith.index_cast %arg11 : index to i32
                      %mask, %scalar_out = pto.plt_b16 %41 : i32 -> !pto.mask<b16>, i32
                      %42 = arith.index_cast %scalar_out : i32 to index
                      %43 = pto.addptr %33, %40 : <bf16, ub> -> <bf16, ub>
                      %result = pto.vlds %43[%c0] : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
                      %44 = pto.addptr %38, %40 : <bf16, ub> -> <bf16, ub>
                      pto.vsts %result, %44[%c0], %mask : !pto.vreg<128xbf16>, !pto.ptr<bf16, ub>, !pto.mask<b16>
                      scf.yield %42 : index
                    }
                  }
                }
