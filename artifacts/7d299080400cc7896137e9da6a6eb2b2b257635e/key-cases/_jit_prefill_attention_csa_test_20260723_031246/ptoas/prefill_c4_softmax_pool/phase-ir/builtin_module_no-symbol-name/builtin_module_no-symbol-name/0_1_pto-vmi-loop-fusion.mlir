  ...
  func.func @prefill_c4_softmax_pool(%arg0: memref<?xi32, #pto.address_space<gm>>, %arg1: memref<?xi32, #pto.address_space<gm>>, %arg2: memref<?xi32, #pto.address_space<gm>>, %arg3: memref<?xf32, #pto.address_space<gm>>, %arg4: memref<?xi32, #pto.address_space<gm>>, %arg5: memref<?xf32, #pto.address_space<gm>>, %arg6: memref<?xf32, #pto.address_space<gm>>, %arg7: memref<?xf32, #pto.address_space<gm>>, %arg8: memref<?xf32, #pto.address_space<gm>>, %arg9: index, %arg10: i32, %arg11: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    scf.if %7 {
      ...
      pto.fusion_region {
        ...
        %36 = pto.vmi.vsub %34, %35, %33 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
        ...
        %41 = pto.vmi.create_mask %c256 {pto.tilelib.candidate = "vmi_texp_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "texp"} : index -> !pto.vmi.mask<256xpred>
        %42 = pto.vmi.vload %38[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
        %43 = pto.vmi.vexp %42, %41 : !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
        pto.vmi.vstore %43, %40[%c0], %41 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
        ...
        %46 = pto.pointer_cast(%c9216_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
        %47 = pto.castptr %46 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %48 = pto.vmi.vload %45[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
        pto.vmi.vstore %48, %47[%c0], %25 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
        %49 = pto.pointer_cast(%c21504_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
        %50 = pto.castptr %49 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %51 = pto.pointer_cast(%c10240_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
        %52 = pto.castptr %51 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
        %53 = pto.vmi.vload %50[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
        pto.vmi.vstore %53, %52[%c0], %25 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
        pto.yield() : () -> ()
      ...
      scf.for %arg12 = %c0 to %c7 step %c1 {
        ...
        scf.if %23 {
          ...
          pto.fusion_region {
            ...
            %45 = pto.vmi.vload %40[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %46 = pto.vmi.vsub %44, %45, %43 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %46, %42[%c0], %43 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %47 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %48 = pto.castptr %47 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %49 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %50 = pto.castptr %49 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %51 = pto.vmi.create_mask %c256 {pto.tilelib.candidate = "vmi_texp_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "texp"} : index -> !pto.vmi.mask<256xpred>
            %52 = pto.vmi.vload %48[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %53 = pto.vmi.vexp %52, %51 : !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %53, %50[%c0], %51 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %54 = pto.pointer_cast(%25) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %55 = pto.castptr %54 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %56 = pto.pointer_cast(%c11264_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %57 = pto.castptr %56 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %58 = pto.pointer_cast(%c0_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %59 = pto.castptr %58 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %60 = pto.vmi.vload %55[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %61 = pto.vmi.vload %57[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %62 = pto.vmi.vsub %60, %61, %43 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %62, %59[%c0], %43 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            ...
            %64 = pto.castptr %63 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %65 = pto.pointer_cast(%c0_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %66 = pto.castptr %65 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %67 = pto.vmi.vload %64[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %68 = pto.vmi.vexp %67, %51 : !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %68, %66[%c0], %51 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %69 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %70 = pto.castptr %69 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %71 = pto.pointer_cast(%c9216_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %72 = pto.castptr %71 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %73 = pto.pointer_cast(%c13312_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %74 = pto.castptr %73 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %75 = pto.vmi.create_mask %c256 {pto.tilelib.candidate = "vmi_tmul", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmul"} : index -> !pto.vmi.mask<256xpred>
            %76 = pto.vmi.vload %70[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %77 = pto.vmi.vload %72[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %78 = pto.vmi.vmul %76, %77, %75 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %78, %74[%c0], %75 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %79 = pto.pointer_cast(%c13312_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %80 = pto.castptr %79 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %81 = pto.pointer_cast(%c0_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %82 = pto.castptr %81 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %83 = pto.pointer_cast(%c13312_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %84 = pto.castptr %83 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %85 = pto.vmi.create_mask %c256 {pto.tilelib.candidate = "vmi_tadd_block64", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tadd"} : index -> !pto.vmi.mask<256xpred>
            %86 = pto.vmi.vload %80[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %87 = pto.vmi.vload %82[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %88 = pto.vmi.vadd %86, %87, %85 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %88, %84[%c0], %85 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %89 = pto.pointer_cast(%c10240_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %90 = pto.castptr %89 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %91 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %92 = pto.castptr %91 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %93 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %94 = pto.castptr %93 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %95 = pto.vmi.vload %90[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %96 = pto.vmi.vload %92[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %97 = pto.vmi.vmul %95, %96, %75 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %97, %94[%c0], %75 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %98 = pto.pointer_cast(%26) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %99 = pto.castptr %98 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %100 = pto.pointer_cast(%c0_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %101 = pto.castptr %100 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %102 = pto.pointer_cast(%c14336_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %103 = pto.castptr %102 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %104 = pto.vmi.vload %99[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %105 = pto.vmi.vload %101[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %106 = pto.vmi.vmul %104, %105, %75 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %106, %103[%c0], %75 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %107 = pto.pointer_cast(%c12288_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %108 = pto.castptr %107 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %109 = pto.pointer_cast(%c14336_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %110 = pto.castptr %109 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %111 = pto.pointer_cast(%c14336_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %112 = pto.castptr %111 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %113 = pto.vmi.vload %108[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %114 = pto.vmi.vload %110[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            %115 = pto.vmi.vadd %113, %114, %85 : !pto.vmi.vreg<256xf32>, !pto.vmi.vreg<256xf32>, !pto.vmi.mask<256xpred> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %115, %112[%c0], %85 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %116 = pto.pointer_cast(%c11264_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %117 = pto.castptr %116 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %118 = pto.pointer_cast(%c8192_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %119 = pto.castptr %118 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %120 = pto.vmi.create_mask %c256 {pto.tilelib.candidate = "vmi_tmov", pto.tilelib.impl = "vmi", pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tmov"} : index -> !pto.vmi.mask<256xpred>
            %121 = pto.vmi.vload %117[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %121, %119[%c0], %120 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %122 = pto.pointer_cast(%c13312_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %123 = pto.castptr %122 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %124 = pto.pointer_cast(%c9216_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %125 = pto.castptr %124 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %126 = pto.vmi.vload %123[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %126, %125[%c0], %120 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            %127 = pto.pointer_cast(%c14336_i64) %c1, %c256 {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %128 = pto.castptr %127 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %129 = pto.pointer_cast(%c10240_i64) {config = #pto.tile_buf_config<blayout=#pto.blayout<row_major>, slayout=#pto.slayout<none_box>, s_fractal_size=512, pad=#pto.pad_value<null>, compact=#pto.compact_mode<null>>} : memref<1x256xf32, #pto.address_space<vec>>
            %130 = pto.castptr %129 : memref<1x256xf32, #pto.address_space<vec>> -> !pto.ptr<f32, ub>
            %131 = pto.vmi.vload %128[%c0] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<256xf32>
            pto.vmi.vstore %131, %130[%c0], %120 : !pto.vmi.vreg<256xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<256xpred>
            pto.yield() : () -> ()
