  ...
  func.func @rope(%arg0: memref<?xbf16, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xf32, #pto.address_space<gm>>, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
    ...
    %12 = pto.fusion_region {
      ...
      scf.for %arg6 = %c0 to %c64 step %c1 {
        ...
        %56 = arith.muli %arg6, %c32 : index
        %57 = pto.vmi.vload %22[%56] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
        %58 = pto.vmi.vmuls %57, %cst_0, %25 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
        pto.vmi.vstore %58, %24[%56], %25 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
      ...
      scf.for %arg6 = %c0 to %c64 step %c1 {
        ...
        %56 = arith.muli %arg6, %c32 : index
        %57 = pto.vmi.vload %31[%56] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
        %58 = pto.vmi.vload %33[%56] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
        %59 = pto.vmi.vsub %57, %58, %36 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
        pto.vmi.vstore %59, %35[%56], %36 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
        %60 = arith.muli %arg6, %c32 : index
        %61 = pto.vmi.vload %38[%60] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
        %62 = pto.vmi.vadds %61, %cst_1, %41 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
        pto.vmi.vstore %62, %40[%60], %41 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
        %63 = arith.muli %arg6, %c32 : index
        %64 = pto.vmi.vload %43[%63] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
        %65 = pto.vmi.vmuls %64, %cst, %25 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
        pto.vmi.vstore %65, %45[%63], %25 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
      } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      ...
      scf.for %arg7 = %c0 to %c32 step %c16 {
        ...
        %45 = pto.fusion_region {
          ...
          scf.for %arg8 = %c0 to %c64 step %c1 {
            ...
            %85 = arith.muli %arg8, %c32 : index
            %86 = pto.vmi.vload %63[%85] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
            %87 = pto.vmi.vload %65[%85] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
            %88 = pto.vmi.vmul %86, %87, %61 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
            pto.vmi.vstore %88, %67[%85], %61 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
            %89 = arith.muli %arg8, %c32 : index
            %90 = pto.vmi.vload %69[%89] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
            %91 = pto.vmi.vload %71[%89] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
            %92 = pto.vmi.vadd %90, %91, %74 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
            pto.vmi.vstore %92, %73[%89], %74 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
          } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
