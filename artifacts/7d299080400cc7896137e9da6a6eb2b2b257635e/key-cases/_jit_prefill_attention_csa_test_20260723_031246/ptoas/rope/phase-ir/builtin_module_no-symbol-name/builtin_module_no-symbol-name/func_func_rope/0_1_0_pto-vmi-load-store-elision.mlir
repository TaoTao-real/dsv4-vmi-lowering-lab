...
func.func @rope(%arg0: memref<?xbf16, #pto.address_space<gm>>, %arg1: memref<?xf32, #pto.address_space<gm>>, %arg2: memref<?xf32, #pto.address_space<gm>>, %arg3: memref<?xf32, #pto.address_space<gm>>, %arg4: i32, %arg5: i32) attributes {pto.kernel_kind = #pto.kernel_kind<vector>} {
  ...
  %12 = pto.fusion_region {
    ...
    scf.for %arg6 = %c0 to %c64 step %c1 {
      ...
      %56 = pto.vmi.vmuls %55, %cst_0, %25 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
      pto.vmi.vstore %56, %24[%53], %25 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
    ...
    scf.for %arg6 = %c0 to %c64 step %c1 {
      ...
      %56 = pto.vmi.vload %31[%53] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
      %57 = pto.vmi.vsub %56, %55, %36 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
      %58 = pto.vmi.vadds %56, %cst_1, %41 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
      pto.vmi.vstore %58, %40[%53], %41 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
      %59 = pto.vmi.vmuls %57, %cst, %25 : !pto.vmi.vreg<32xf32>, f32, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
      pto.vmi.vstore %59, %45[%53], %25 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
    } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
    ...
    scf.for %arg7 = %c0 to %c32 step %c16 {
      ...
      %45 = pto.fusion_region {
        ...
        scf.for %arg8 = %c0 to %c64 step %c1 {
          ...
          %85 = pto.vmi.vload %63[%81] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
          %86 = pto.vmi.vload %65[%81] : !pto.ptr<f32, ub> -> !pto.vmi.vreg<32xf32>
          %87 = pto.vmi.vmul %85, %86, %61 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
          pto.vmi.vstore %87, %67[%81], %61 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
          %88 = pto.vmi.vadd %84, %87, %74 : !pto.vmi.vreg<32xf32>, !pto.vmi.vreg<32xf32>, !pto.vmi.mask<32xpred> -> !pto.vmi.vreg<32xf32>
          pto.vmi.vstore %88, %73[%81], %74 : !pto.vmi.vreg<32xf32>, !pto.ptr<f32, ub>, !pto.vmi.mask<32xpred>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
