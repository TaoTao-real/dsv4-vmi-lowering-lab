      ...
      scf.for %arg6 = %c0 to %c32 step %c2 {
        ...
        pto.vecscope {
          ...
          scf.for %arg7 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
            ...
            pto.mem_bar "VST_VLD"
            %result_10 = pto.vlds %26[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %result_11 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %34 = pto.vmul %result_10, %result_5, %28 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %35 = pto.vmul %result_11, %result_6, %28 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
