    ...
    func.func @rope(%arg0: !pto.ptr<bf16, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: i32, %arg5: i32) attributes {pto.entry, pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          ...
          pto.mem_bar "VST_VLD"
          %result_4 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %26 = pto.vmuls %result_4, %cst_0, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %26, %17[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VV_ALL"
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          ...
          %result_4 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          pto.mem_bar "VST_VLD"
          %result_5 = pto.vlds %17[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %26 = pto.vsub %result_4, %result_5, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %26, %17[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %result_6 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %27 = pto.vadds %result_6, %cst, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %27, %22[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_7 = pto.vlds %17[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %28 = pto.vmuls %result_7, %cst_1, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %28, %17[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_8 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          pto.mem_bar "VST_VLD"
          %result_9 = pto.vlds %17[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %29 = pto.vsub %result_8, %result_9, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %29, %22[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VV_ALL"
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
        ...
        scf.for %arg7 = %c0 to %c32 step %c16 {
          ...
          pto.vecscope {
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              %47 = pto.vmul %result, %result_2, %43 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %47, %11[%46], %44 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              %result_3 = pto.vlds %9[%46] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              pto.mem_bar "VST_VLD"
              %result_4 = pto.vlds %11[%46] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              %48 = pto.vadd %result_3, %result_4, %43 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              pto.vsts %48, %9[%46], %44 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              pto.mem_bar "VV_ALL"
            } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
          }
