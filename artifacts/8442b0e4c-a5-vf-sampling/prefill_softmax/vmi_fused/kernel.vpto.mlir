      ...
      scf.if %7 {
        ...
        pto.vecscope {
          ...
          scf.for %arg12 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
            ...
            %32 = pto.vexp %31, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          ...
          scf.for %arg12 = %c0_i16 to %c7_i16 step %c1_i16  : i16 {
            ...
            scf.if %32 {
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %47 = pto.vexp %46, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %48 = pto.vadd %47, %46, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %48, %41[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_3 = pto.vlds %28[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %49 = pto.vmul %result_3, %result_1, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                pto.vsts %46, %28[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            }
            pto.mem_bar "VV_ALL"
          }
