      ...
      scf.if %7 {
        ...
        pto.vecscope {
          ...
          scf.for %arg12 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
            ...
            %31 = pto.vsub %result, %result, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %31, %23[%30], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.mem_bar "VST_VLD"
            %result_1 = pto.vlds %23[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %32 = pto.vexp %result_1, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %32, %23[%30], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.mem_bar "VST_VLD"
            %result_2 = pto.vlds %23[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            pto.vsts %result_2, %25[%30], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          ...
          scf.for %arg12 = %c0_i16 to %c7_i16 step %c1_i16  : i16 {
            ...
            scf.if %32 {
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %46 = pto.vsub %result, %result_1, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %46, %38[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.mem_bar "VST_VLD"
                %result_2 = pto.vlds %38[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %47 = pto.vexp %result_2, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %47, %38[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
              pto.mem_bar "VST_VLD"
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %46 = pto.vexp %result, %26 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %46, %39[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_1 = pto.vlds %38[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_2 = pto.vlds %25[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %47 = pto.vmul %result_1, %result_2, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %47, %41[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.mem_bar "VST_VLD"
                %result_3 = pto.vlds %41[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.mem_bar "VST_VLD"
                %result_4 = pto.vlds %39[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %48 = pto.vadd %result_3, %result_4, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %48, %41[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_5 = pto.vlds %28[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_6 = pto.vlds %38[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %49 = pto.vmul %result_5, %result_6, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %49, %38[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
              pto.mem_bar "VST_VLD"
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %46 = pto.vadd %result, %result_1, %26 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %46, %43[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_2 = pto.vlds %23[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_2, %21[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_3 = pto.vlds %41[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_3, %25[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.mem_bar "VST_VLD"
                %result_4 = pto.vlds %43[%45] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_4, %28[%45], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            }
            pto.mem_bar "VV_ALL"
          }
