      ...
      scf.for %arg6 = %c0 to %c32 step %c2 {
        ...
        pto.vecscope {
          ...
          scf.for %arg7 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
            %28 = arith.index_cast %arg7 : i16 to index
            %29 = arith.muli %28, %c128 : index
            %result_7 = pto.vlds %25[%29] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %30 = arith.addi %29, %c64 : index
            %result_8 = pto.vlds %25[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %31 = pto.vmul %result_7, %result_5, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %32 = pto.vmul %result_8, %result_6, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %31, %25[%29], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.vsts %32, %25[%30], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
