      ...
      scf.for %arg6 = %c0 to %c32 step %c2 {
        ...
        pto.vecscope {
          ...
          scf.for %arg7 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
            ...
            %result = pto.vlds %4[%24] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
            %25 = arith.addi %24, %c64 : index
            %result_3 = pto.vlds %4[%25] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
            %26 = pto.vcvt %result, %22 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
            %27 = pto.vcvt %result_3, %22 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
            pto.vsts %26, %20[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.vsts %27, %20[%25], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          } {pto.tilelib.candidate = "vmi_tcvt", pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib", pto.vmi.fusion.tileop = "tcvt"}
        }
        ...
        pto.vecscope {
          ...
          %result_3 = pto.vlds %5[%c64] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
          %21 = pto.pset_b16 "PAT_ALL" : !pto.mask<b16>
          %22 = pto.vcvt %result, %21 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
          %23 = pto.vcvt %result_3, %21 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
          %24 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
          pto.vsts %22, %20[%c0], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.vsts %23, %20[%c64], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          ...
          scf.for %arg7 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
            ...
            %result_4 = pto.vlds %26[%28] {dist = "BRC_B32"} : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %29 = arith.muli %28, %c128 : index
            %result_5 = pto.vlds %25[%29] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %30 = arith.addi %29, %c64 : index
            %result_6 = pto.vlds %25[%30] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %31 = pto.vmul %result_5, %result_4, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %32 = pto.vmul %result_6, %result_4, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %33 = pto.vmul %31, %22, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            %34 = pto.vmul %32, %23, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        pto.vecscope {
          ...
          scf.for %arg7 = %c0_i16 to %c8_i16 step %c1_i16  : i16 {
            %23 = arith.index_cast %arg7 : i16 to index
            %24 = arith.muli %23, %c128 : index
            %result = pto.vlds %3[%24] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
            %25 = arith.addi %24, %c64 : index
            %result_3 = pto.vlds %3[%25] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
            %26 = pto.vcvt %result, %22 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
            %27 = pto.vcvt %result_3, %22 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
            pto.vsts %26, %20[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.vsts %27, %20[%25], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        ...
        pto.vecscope {
          ...
          %result_3 = pto.vlds %6[%c64] {dist = "UNPK_B16"} : !pto.ptr<bf16, ub> -> !pto.vreg<128xbf16>
          %21 = pto.pset_b16 "PAT_ALL" : !pto.mask<b16>
          %22 = pto.vcvt %result, %21 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
          %23 = pto.vcvt %result_3, %21 {part = "EVEN"} : !pto.vreg<128xbf16>, !pto.mask<b16> -> !pto.vreg<64xf32>
          %24 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
