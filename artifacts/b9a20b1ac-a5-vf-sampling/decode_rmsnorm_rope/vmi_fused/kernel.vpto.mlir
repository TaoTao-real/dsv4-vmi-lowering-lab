  ...
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<vector>, pto.target_arch = "a5"} {
    func.func @rmsnorm_rope(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<bf16, gm>, %arg4: !pto.ptr<bf16, gm>) attributes {pto.entry, pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          %28 = arith.index_cast %arg5 : i16 to index
          %result_6 = pto.vlds %26[%28] {dist = "BRC_B32"} : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          ...
          %31 = pto.vmul %30, %25, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
      ...
      pto.vecscope {
        ...
        %23 = pto.castptr %c0_i64 : i64 -> !pto.ptr<f32, ub>
        %result = pto.vlds %23[%c0] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
        %24 = pto.pge_b32 "PAT_ALL" : !pto.mask<b32>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %29 = pto.vmul %28, %result, %25 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %29, %0[%27], %24 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
      ...
      pto.vecscope {
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %result_6 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %32 = pto.vmul %result_6, %25, %24 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %32, %26[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %33 = pto.vmuls %32, %cst_3, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          %30 = arith.index_cast %arg5 : i16 to index
          %31 = arith.muli %30, %c64 : index
          %result_6 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %32 = pto.vcvt %result_6, %24 {rnd = "Z", sat = "NOSAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xi32>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          %30 = arith.index_cast %arg5 : i16 to index
          %31 = arith.muli %30, %c64 : index
          %result_6 = pto.vlds %17[%31] : !pto.ptr<i32, ub> -> !pto.vreg<64xi32>
          %32 = pto.vcvt %result_6, %24 {rnd = "A"} : !pto.vreg<64xi32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %32, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %33 = pto.vcvt %32, %24 {rnd = "A", sat = "NOSAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xi32>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %31 = arith.muli %30, %c64 : index
          %result_6 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %32 = pto.vmuls %result_6, %cst_4, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          %result_7 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %33 = pto.vsub %result_7, %32, %24 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %33, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %34 = pto.vadds %result_7, %cst_2, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          %35 = pto.vmuls %33, %cst_4, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %35, %28[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %36 = pto.vsub %34, %35, %24 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %31 = arith.muli %30, %c64 : index
          %result_6 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %32 = pto.vcvt %result_6, %24 {rnd = "A", sat = "NOSAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xi32>
          pto.vsts %32, %29[%31], %23 : !pto.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.mask<b32>
          %result_7 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %33 = pto.vmuls %result_7, %cst_4, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %33, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
      ...
      pto.vecscope {
        ...
        %28 = pto.castptr %c20544_i64 : i64 -> !pto.ptr<f32, ub>
        %29 = pto.castptr %c16448_i64 : i64 -> !pto.ptr<f32, ub>
        %30 = pto.castptr %c25152_i64 : i64 -> !pto.ptr<f32, ub>
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %37 = pto.vmul %36, %result_9, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %37, %31[%34], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %38 = pto.vadd %35, %37, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
