  ...
  module attributes {pto.backend = "vpto", pto.kernel_kind = #pto.kernel_kind<vector>, pto.target_arch = "a5"} {
    func.func @rmsnorm_rope(%arg0: !pto.ptr<f32, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<bf16, gm>, %arg4: !pto.ptr<bf16, gm>) attributes {pto.entry, pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        %26 = pto.castptr %c29248_i64 : i64 -> !pto.ptr<f32, ub>
        %mask, %scalar_out = pto.plt_b32 %c32_i32 : i32 -> !pto.mask<b32>, i32
        %27 = pto.pand %23, %mask, %24 : !pto.mask<b32>, !pto.mask<b32>, !pto.mask<b32> -> !pto.mask<b32>
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          %28 = arith.index_cast %arg5 : i16 to index
          %29 = arith.muli %28, %c32 : index
          pto.vsts %25, %22[%29], %27 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.vsts %25, %26[%29], %27 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VST"
      ...
      pto.vecscope {
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          pto.mem_bar "VST_VLD"
          %result_9 = pto.vlds %0[%29] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %31 = pto.vmul %result_9, %result_6, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %31, %0[%29], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
      ...
      pto.vecscope {
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %28 = pto.vmul %result_7, %result_6, %25 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %28, %0[%27], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_8 = pto.vlds %0[%27] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %29 = pto.vmul %result_8, %result, %25 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %29, %0[%27], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
      ...
      pto.vecscope {
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %33 = pto.vmuls %result_8, %cst_3, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %33, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
        pto.mem_bar "VST_VLD"
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          %30 = arith.index_cast %arg5 : i16 to index
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %33 = pto.vcvt %result_8, %24 {rnd = "A", sat = "NOSAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xi32>
          pto.vsts %33, %27[%31], %23 : !pto.vreg<64xi32>, !pto.ptr<i32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %result_8 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          pto.mem_bar "VST_VLD"
          %result_9 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %33 = pto.vsub %result_8, %result_9, %24 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %33, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %result_10 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %34 = pto.vadds %result_10, %cst_2, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %34, %26[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_11 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %35 = pto.vmuls %result_11, %cst_4, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %35, %28[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_12 = pto.vlds %26[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %result_13 = pto.vlds %28[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %36 = pto.vsub %result_12, %result_13, %24 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %36, %26[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %result_8 = pto.vlds %22[%31] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %33 = pto.vmuls %result_8, %cst_4, %23 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %33, %22[%31], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
      ...
      pto.vecscope {
        ...
        %31 = pto.castptr %c25152_i64 : i64 -> !pto.ptr<f32, ub>
        pto.mem_bar "VST_VLD"
        ...
        scf.for %arg5 = %c0_i16 to %c16_i16 step %c1_i16  : i16 {
          ...
          %35 = pto.vmul %result, %result_6, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %35, %0[%34], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %result_7 = pto.vlds %29[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %result_8 = pto.vlds %22[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %36 = pto.vmul %result_7, %result_8, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %36, %30[%34], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_9 = pto.vlds %30[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %result_10 = pto.vlds %31[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %37 = pto.vmul %result_9, %result_10, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %37, %30[%34], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          pto.mem_bar "VST_VLD"
          %result_11 = pto.vlds %0[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %result_12 = pto.vlds %30[%34] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %38 = pto.vadd %result_11, %result_12, %32 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %38, %0[%34], %23 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
        } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
      }
