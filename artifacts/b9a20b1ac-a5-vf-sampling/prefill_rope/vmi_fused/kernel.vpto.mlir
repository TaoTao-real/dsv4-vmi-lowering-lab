    ...
    func.func @rope(%arg0: !pto.ptr<bf16, gm>, %arg1: !pto.ptr<f32, gm>, %arg2: !pto.ptr<f32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: i32, %arg5: i32) attributes {pto.entry, pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      pto.vecscope {
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          ...
          %result_2 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %25 = pto.vmul %result_2, %20, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          pto.vsts %25, %22[%24], %21 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          %26 = pto.vmuls %25, %cst_0, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          %23 = arith.index_cast %arg6 : i16 to index
          %24 = arith.muli %23, %c32 : index
          %result_2 = pto.vlds %17[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %25 = pto.vcvt %result_2, %19 {rnd = "Z", sat = "NOSAT"} : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xi32>
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          %23 = arith.index_cast %arg6 : i16 to index
          %24 = arith.muli %23, %c32 : index
          %result_2 = pto.vlds %6[%24] : !pto.ptr<i32, ub> -> !pto.vreg<64xi32>
          %25 = pto.vcvt %result_2, %19 {rnd = "A"} : !pto.vreg<64xi32>, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        scf.for %arg6 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
          ...
          %24 = arith.muli %23, %c32 : index
          %result_2 = pto.vlds %17[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %25 = pto.vmuls %result_2, %cst_1, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          %result_3 = pto.vlds %22[%24] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
          %26 = pto.vsub %result_3, %25, %19 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
          %27 = pto.vadds %result_3, %cst, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
          %28 = pto.vmuls %26, %cst_1, %18 : !pto.vreg<64xf32>, f32, !pto.mask<b32> -> !pto.vreg<64xf32>
        ...
        scf.for %arg7 = %c0 to %c32 step %c16 {
          ...
          pto.vecscope {
            ...
            scf.for %arg8 = %c0_i16 to %c64_i16 step %c1_i16  : i16 {
              ...
              %48 = pto.vadd %result_3, %47, %43 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
