      ...
      scf.if %7 {
        ...
        pto.vecscope {
          ...
          scf.for %arg12 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
            ...
            pto.vsts %30, %24[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            %result_1 = pto.vlds %25[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            pto.vsts %result_1, %26[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          ...
          scf.for %arg12 = %c0_i16 to %c7_i16 step %c1_i16  : i16 {
            ...
            scf.if %30 {
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %result_3 = pto.vlds %26[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                pto.vsts %44, %26[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            }
            pto.mem_bar "VV_ALL"
          }
