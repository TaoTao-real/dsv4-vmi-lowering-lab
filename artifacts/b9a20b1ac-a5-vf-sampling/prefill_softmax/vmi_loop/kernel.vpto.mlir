    ...
    func.func @prefill_c4_softmax_pool(%arg0: !pto.ptr<i32, gm>, %arg1: !pto.ptr<i32, gm>, %arg2: !pto.ptr<i32, gm>, %arg3: !pto.ptr<f32, gm>, %arg4: !pto.ptr<i32, gm>, %arg5: !pto.ptr<f32, gm>, %arg6: !pto.ptr<f32, gm>, %arg7: !pto.ptr<f32, gm>, %arg8: !pto.ptr<f32, gm>, %arg9: index, %arg10: i32, %arg11: i32) attributes {pto.entry, pto.kernel_kind = #pto.kernel_kind<vector>} {
      ...
      scf.if %7 {
        ...
        pto.vecscope {
          ...
          %24 = pto.castptr %c9216_i64 : i64 -> !pto.ptr<f32, ub>
          %25 = pto.castptr %c21504_i64 : i64 -> !pto.ptr<f32, ub>
          %26 = pto.castptr %c10240_i64 : i64 -> !pto.ptr<f32, ub>
          ...
          scf.for %arg12 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
            ...
            pto.mem_bar "VST_VLD"
            %result_1 = pto.vlds %21[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %29 = pto.vsub %result_1, %result_1, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %29, %23[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.mem_bar "VST_VLD"
            %result_2 = pto.vlds %23[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            %30 = pto.vexp %result_2, %27 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
            pto.vsts %30, %23[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            pto.mem_bar "VST_VLD"
            %result_3 = pto.vlds %23[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            pto.vsts %result_3, %24[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
            %result_4 = pto.vlds %25[%28] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
            pto.vsts %result_4, %26[%28], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
          ...
          scf.for %arg12 = %c0_i16 to %c7_i16 step %c1_i16  : i16 {
            ...
            scf.if %30 {
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                pto.mem_bar "VST_VLD"
                %result_2 = pto.vlds %36[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %45 = pto.vexp %result_2, %27 : !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %45, %36[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
              pto.mem_bar "VST_VLD"
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %result_2 = pto.vlds %24[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %45 = pto.vmul %result_1, %result_2, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %45, %39[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.mem_bar "VST_VLD"
                %result_3 = pto.vlds %39[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.mem_bar "VST_VLD"
                %result_4 = pto.vlds %37[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %46 = pto.vadd %result_3, %result_4, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %46, %39[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_5 = pto.vlds %26[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %result_6 = pto.vlds %36[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                %47 = pto.vmul %result_5, %result_6, %27 : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
                pto.vsts %47, %36[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
              pto.mem_bar "VST_VLD"
              ...
              scf.for %arg13 = %c0_i16 to %c256_i16 step %c64_i16  : i16 {
                ...
                %result_2 = pto.vlds %23[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_2, %21[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                %result_3 = pto.vlds %39[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_3, %24[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
                pto.mem_bar "VST_VLD"
                %result_4 = pto.vlds %41[%43] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
                pto.vsts %result_4, %26[%43], %22 : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
              } {pto.tilelib.impl = "vmi", pto.vmi.fusion.principal_loop, pto.vmi.fusion.source = "tilelib"}
            }
            pto.mem_bar "VV_ALL"
          }
